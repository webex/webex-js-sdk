...
module.exports = function (packageName, argv) {
  ...
  browsers = Object.assign(
    ...
    ...Object.entries(browsers).map(([key, browser]) => {
      if (!browser.base) {
        return {[key]: {}};
      } else if (browser.base.toLowerCase().includes('chrome') && !browser.flags) {
        return {
          [key]: {
            ...browser,
            'goog:chromeOptions': {
      ...
      } else if (browser.base.toLowerCase().includes('firefox') && !browser.prefs) {
        return {
          [key]: {
            ...browser,
            prefs: {
      ...
      } else if (browser.base.toLowerCase().includes('edge') && !browser.flags) {
        return {
          [key]: {
            ...browser,
            'ms:edgeOptions': {
      ...
      } else if (browser.base.toLowerCase().includes('safari') && !browser['webkit:WebRTC']) {
        return {
          [key]: {
            ...browser,
            'webkit:WebRTC': {
