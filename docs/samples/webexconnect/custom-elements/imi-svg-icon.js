class ImiSvgIconElement extends HTMLElement {
  constructor() {
    super();
  }
  ...
  connectedCallback() {
    this.setAttribute("style", "fill:currentColor");
    SVGInject(this, { copyAttributes: true });
  }
}
customElements.define("imi-svg-icon", ImiSvgIconElement);
...
(function (window, document) {
  ...
  function getAbsoluteUrl(url) {
    ...
    return document.querySelector('base').href + url;
    // let currentUrl = window.location.href;
    // return currentUrl.replace("/index.html" + window.location.hash, url);
  }
  ...
  function inject(imgElem, svgElem, absUrl, options) {
    if (svgElem) {
      ...
      if (parentNode) {
        ...
        //IMI-Changed above logic to append child
        imgElem.appendChild(injectElem);
