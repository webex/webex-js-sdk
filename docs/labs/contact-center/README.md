...
This lab demonstrates how to use the Webex Contact Center SDK with a single, modular implementation pattern.
...
## Understanding the Lab: Step-by-Step Guide (`lab.html`)
...
// The initialized 'webex' object is then used for subsequent operations.
```
