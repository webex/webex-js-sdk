...
// CA roots are generated by tooling/generate-kms-caroots.js (see the wrapper
// tooling/with-kms-caroots.sh). When the fixture is empty, validation is skipped.
// eslint-disable-next-line import/no-unresolved, global-require
const caroots = require('./kms-caroots.fixture.json');
const webexTestConfig = caroots.length
  ? {encryption: {caroots, shouldValidateKMSCertificate: true}}
  : {encryption: {shouldValidateKMSCertificate: false}};
