  ...
  describe('StatsAnalyzer', () => {
    ...
    describe('startAnalyzer', () => {
      ...
      it('logs a message when audio receive packets do not increase', async () => {
        await startStatsAnalyzer(
          {expected: {receiveAudio: true}},
          {audio: {remote: EVENTS.REMOTE_MEDIA_STARTED}}
        );
      ...
      it('does not log a message when audio receive packets increase', async () => {
        await startStatsAnalyzer(
          {expected: {receiveAudio: true}},
          {audio: {remote: EVENTS.REMOTE_MEDIA_STOPPED}}
        );
      ...
      it('logs a message when video receive packets do not increase', async () => {
        await startStatsAnalyzer(
          {expected: {receiveVideo: true}},
          {video: {remote: EVENTS.REMOTE_MEDIA_STARTED}}
        );
      ...
      it('does not log a message when video receive packets increase', async () => {
        await startStatsAnalyzer(
          {expected: {receiveVideo: true}},
          {video: {remote: EVENTS.REMOTE_MEDIA_STOPPED}}
        );
      ...
      it('does not log a message when share receive packets increase', async () => {
        await startStatsAnalyzer(
          {expected: {sendShare: true}},
          {share: {remote: EVENTS.REMOTE_MEDIA_STOPPED}}
        );
