 ...
 * @returns {String}
 */
const insertBandwidthLimit = (sdpLines: string, index: number) => {
 ...
 */
pc.setContentSlides = (screenPc: RTCPeerConnection) => {
 ...
 * @returns {undefined}
 */
pc.replaceTrack = (peerConnection: object, track: object) => {
  try {
 ...
 * @returns {undefined}
 */
pc.addStream = (peerConnection: object, stream: object) => {
  try {
 ...
 * @returns {undefined}
 */
pc.setRemoteSessionDetails = (peerConnection: object, typeStr: string, remoteSdp: string, meetingId: string) => {
 ...
 * @returns {Promise.RTCPeerConnection}
 */
pc.rollBackLocalDescription = (peerConnection: object) => peerConnection
 ...
 * @returns {undefined}
 */
pc.close = (peerConnection: object) => {
