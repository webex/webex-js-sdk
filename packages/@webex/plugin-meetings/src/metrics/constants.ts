...
const BEHAVIORAL_METRICS = {
  ...
  FETCH_PERSISTENT_MEETING_LINK_SUCCESS: 'js_sdk_fetch_persistent_meeting_link_success',
  FETCH_PERSISTENT_MEETING_LINK_FAILURE: 'js_sdk_fetch_persistent_meeting_link_failure',
