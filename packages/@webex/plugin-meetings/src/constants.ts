...
export const EVENT_TRIGGERS = {
  ...
  MEETING_NO_AUDIO_SENT: 'meeting:noAudioSent',
  MEETING_NO_AUDIO_RECEIVED: 'meeting:noAudioReceived',
  MEETING_NO_FRAMES_SENT: 'meeting:noFramesSent',
  MEETING_NO_FRAMES_RECEIVED: 'meeting:noFramesreceived',
  MEETING_NO_VIDEO_ENCODED: 'meeting:noVideoEncoded',
  MEETING_NO_VIDEO_DECODED: 'meeting:noVideoDecoded',
