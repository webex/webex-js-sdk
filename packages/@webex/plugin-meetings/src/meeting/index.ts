    ...
    if (this.userDisplayHints !== undefined) {
      changed =
        this.inMeetingActions.set({
          ...
          isStartedLocalRecording: MeetingUtil.isStartedLocalRecording(this.userDisplayHints),
          isStoppedLocalRecording: MeetingUtil.isStoppedLocalRecording(this.userDisplayHints),
          isPausedLocalRecording: MeetingUtil.isPausedLocalRecording(this.userDisplayHints),
