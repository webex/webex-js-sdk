...
Each service folder can contain its own `ai-docs/` with:
- `AGENTS.md` - Usage examples, API reference
- `ARCHITECTURE.md` - Technical details, diagrams

| Service | Location |
|---------|----------|
| Agent | `src/services/agent/ai-docs/` |
| Task | `src/services/task/ai-docs/` |
| Config | `src/services/config/ai-docs/` |
| Core | `src/services/core/ai-docs/` |
...
1. Update relevant service `ai-docs/AGENTS.md`
2. Update `ARCHITECTURE.md` if data flow changes
3. Add new patterns to `patterns/` if introducing new patterns
4. Update templates if the workflow changes
