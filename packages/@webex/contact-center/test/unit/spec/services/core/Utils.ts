...
describe('Utils', () => {
  ...
  describe('calculateDestAgentIdForFetchingDestType', () => {
    const currentAgentId = 'agent-123';
    ...
    it('should return destAgentIdCBT when found', () => {
      ...
      const result = Utils.calculateDestAgentIdForFetchingDestType(interaction, currentAgentId);
      expect(result).toBe('agent-uuid-456');
    });

    it('should return consultingAgent when destAgentIdCBT is empty', () => {
      const consultedAgentId = 'agent-456';
      const interaction: any = {
        media: {
          consult: {
    ...
    it('should return empty string when no consulting agent found', () => {
      const interaction: any = {
        media: {
          mainCall: {
            mType: 'mainCall',
