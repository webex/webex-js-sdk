...
describe(`Encryption`, function() {
  ...
  describe(`#getKey()`, () => {
    ...
    beforeEach(() => {
      ...
      storageGetSpy = sinon.spy(otherSpark.encryption.storage, `get`);
    });
    ...
    it(`fetches the key from the kms`, () => otherSpark.encryption.storage.del(key.uri)
    ...
    it(`stores the newly retrieved key`, () => otherSpark.encryption.getKey(key.uri)
      .then((k) => assert.becomes(otherSpark.encryption.storage.get(k.uri), k)));
  });
