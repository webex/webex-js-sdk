...
import Encryption from '@ciscospark/internal-plugin-encryption';
...
describe('EDiscovery Report API Tests', () => {
  ...
  describe('Create Report Tests', () => {
    it('createReportSuccess', async () => {
      ...
      const result = spark.internal.ediscovery.createReport(reportRequest).then((res) => {
    ...
    it('createReportWithNoParamFailure', async () => {
      const result = expect(spark.internal.ediscovery.createReport()).to.be.rejectedWith(Error, 'Undefined parameter');
      return result;
    });
  });
  ...
  describe('Get Report Tests', () => {
    ...
    it('getReportWithNoParamFailure', async () => {
      const result = expect(spark.internal.ediscovery.getReport()).to.be.rejectedWith(Error, 'Undefined parameter');
      return result;
    });
  });
  ...
  describe('Delete Report Tests', () => {
    ...
    it('deleteReportWithNoParamFailure', async () => {
      const result = expect(spark.internal.ediscovery.deleteReport()).to.be.rejectedWith(Error, 'Undefined parameter');
      return result;
    });
  });
  ...
  describe('Restart Report Tests', () => {
    ...
    it('restartReportWithNoParamFailure', async () => {
      const result = expect(spark.internal.ediscovery.restartReport()).to.be.rejectedWith(Error, 'Undefined parameter');
      return result;
    });
  });
});
