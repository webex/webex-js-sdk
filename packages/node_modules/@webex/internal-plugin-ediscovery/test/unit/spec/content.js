...
describe('EDiscovery Content API Tests', () => {
  ...
  describe('GetContentSummary Tests', () => {
    ...
    it('GetContentSummary initialises contentSummaryBySpaceIdCache if uninitialised', async () => {
  ...
  describe('GetContentSummaryBySpaceId Tests', () => {
    ...
    it('GetContentSummaryBySpaceId initialises contentSummaryBySpaceIdCache if uninitialised', async () => {
      webex.internal.ediscovery.contentSummaryBySpaceIdCache = {
        set: sinon.stub(),
        has: sinon.stub().returns(false),
        clear: sinon.stub()
