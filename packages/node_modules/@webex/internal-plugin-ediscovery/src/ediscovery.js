...
const EDiscovery = WebexPlugin.extend({
   ...
   * @param {Object} options - can specify this option :
   *                           timeoutMs - connection timeout in milliseconds, defaults to 10s
  ...
  createReport(reportRequest, options = {}) {
    ...
    defaults(options, {timeoutMs: defaultTimeoutMs});
   ...
   * @param {Object} options - can specify one or more of these options :
   *                           offset - Start position from which to retrieve records
