    ...
    transforms: [
      ...
      },
      {
        ...
        fn(ctx, object, reportId = '') {
          ...
          const promises = [];
          return ctx.spark.internal.ediscovery.getContentSummaryBySpaceId(reportId, object.targetId)
            .then((res) => {
              const spaceParticipantId = res.body.participants[0] || object.actorId;
