    ...
    describe('RedirectInterceptor', () => {
      ...
      describe('#onResponse', () => {
        it('redirects GET requests to new url on locus redirect error', () => {
          ...
          sinon.assert.calledWith(spark.request, {$redirectCount: 1, uri: 'http://newlocus.example.com'});
        });
        ...
        it('redirects POST requests to new url on locus redirect error', () => {
          ...
          sinon.assert.calledWith(spark.request, {$redirectCount: 5, uri: 'http://newlocus.example.com'});
        });
