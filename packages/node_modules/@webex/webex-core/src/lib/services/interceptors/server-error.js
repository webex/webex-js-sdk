...
export default class ServerErrorInterceptor extends Interceptor {
  ...
  */
  ...
  onResponseError(options, reason) {
    if ((reason instanceof WebexHttpError.InternalServerError || reason instanceof WebexHttpError.BadGateway || reason instanceof WebexHttpError.reason instanceof WebexHttpError.ServiceUnavailable) && options.uri) {
