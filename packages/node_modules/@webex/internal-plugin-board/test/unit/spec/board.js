...
describe('plugin-board', () => {
  ...
  describe('#setSnapshotImage()', () => {
    beforeEach(() => {
      webex.request.resetHistory();
      sinon.stub(webex.internal.board, '_uploadImageToSparkFiles').returns(Promise.resolve({
        downloadUrl: fakeURL
      }));
    ...
    afterEach(() => {
      webex.internal.board._uploadImageToSparkFiles.restore();
      webex.internal.encryption.encryptScr.resetHistory();
    });
  ...
  describe('#_uploadImage()', () => {
    ...
    it('uploads to webex files', () => {
      assert.calledWith(webex.internal.board._uploadImageToSparkFiles, conversation, encryptedData);
    });
  });
  ...
  describe('#_uploadImageToSparkFiles()', () => {
    ...
    it('uses length for upload filesize', () => {
      ...
      return webex.internal.board._uploadImageToSparkFiles(conversation, blob)
        .then(() => {
