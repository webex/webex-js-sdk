...
import {AnnouncementPayload, CaptionLanguageResponse} from './voicea.types';
...
export class VoiceaChannel extends LLMChannel {
  ...
  processCaptionLanguageResponse = (voiceaPayload:CaptionLanguageResponse) => {
