...
describe('plugin-voicea', () => {
  ...
  describe('voicea', () => {
    ...
    describe.only('#processTranscription', () => {
      ...
      it('processes final transcription', async () => {
        ...
        assert.calledOnceWithExactly(functionSpy, voiceaPayload);
        assert.calledOnceWithExactly(triggerSpy, {
          isFinal: true, transcriptId: '3ec73890-bffb-f28b-e77f-99dc13caea7e', translations: undefined, transcript: {text: 'Hello. This is Webex', csis: [3556942592]}
        });
      });
