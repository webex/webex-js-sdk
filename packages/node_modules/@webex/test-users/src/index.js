...
function getClientCredentials(options) {
  ...
  assert(clientId, 'options.clientId or process.env.WEBEX_CLIENT_ID must be defined');
  const clientSecret = options.clientSecret || process.env.WEBEX_CLIENT_SECRET;

  assert(clientSecret, 'options.clientSecret or process.env.WEBEX_CLIENT_SECRET must be defined');
