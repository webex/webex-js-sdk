...
[
  ...
  Team.prototype[verb] = function submitArchiveStateChangeActivity(target, activity) {
    ...
    return this.webex.internal.conversation.getConvoUrl(target)
      .then((url) =>
        this.webex.internal.conversation.prepare(activity, properties)
          .then(
            (a) => this.webex.internal.conversation.submit(a, url)
          ));
  };
});
