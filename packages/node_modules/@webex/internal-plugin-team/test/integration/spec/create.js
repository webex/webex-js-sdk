...
describe('plugin-team', () => {
  ...
  describe('#createConversation()', () => {
    ...
    it('creates a team conversation containing all team members via `includeAllTeamMembers` parameter', () => spark.internal.team.createConversation(team, {displayName, participants: [kirk]}, {includeAllTeamMembers: true})
      .then((tc) => {
        assert.isInternalTeamConversation(tc);
        assert.lengthOf(tc.participants.items, 3);
      }));

    it('decrypts the \'add\' activity appended to the general conversation after team room is created', () => spark.internal.team.createConversation(team, {displayName, participants: [kirk]}, {includeAllTeamMembers: true})
