  ...
  submitLogs(metadata, logs) {
    ...
    return this.webex.credentials.getUserToken()
      ...
      .then(async (token) => {
        ...
        const newClientUploadsSupported = this.webex.internal && this.webex.internal.feature && await this.webex.internal.feature.getFeature('developer', 'web-high-availability');
