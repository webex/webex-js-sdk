    ...
    before('create lyra machine', function () {
      ...
      return retry(() => testUsers.create({
        ...
        .then((machines) => {
          ...
          lyraMachine.webex.internal.device.config.defaults.model = 'SparkBoard Test';
          lyraMachine.webex.internal.device.config.defaults.localizedModel = 'SparkJSSDKTest';
          lyraMachine.webex.internal.device.config.defaults.systemVersion = 'SparkJSSDKTest';
