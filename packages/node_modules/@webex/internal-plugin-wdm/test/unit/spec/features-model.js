...
describe('plugin-wdm', () => {
  describe('FeaturesModel', () => {
    ...
    beforeEach(() => {
      ...
      webex.on('change', sparkChangeSpy);
      webex.on('change:internal.device', sparkChangeDeviceSpy);
      webex.on('change:internal.device.features', sparkChangeDeviceFeaturesSpy);
      webex.on('change:internal.device.features.developer', sparkChangeDeviceFeaturesDeveloperSpy);
    });
