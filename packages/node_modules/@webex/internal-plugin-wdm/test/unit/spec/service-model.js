...
import {ServiceModel} from '@webex/internal-plugin-wdm';
  ...
  describe('ServiceModel', () => {
    ...
    beforeEach('create services', () => {
      ...
      atlasService = new ServiceModel({
        service: 'atlas',
        defaultUrl: `${process.env.ATLAS_SERVICE_URL || 'https://atlas-a.wbx2.com'}/admin/api/v1`
      });
    });
    ...
    it('returns default service url', () => {
      assert.equal(atlasService.url, `${process.env.ATLAS_SERVICE_URL || 'https://atlas-a.wbx2.com'}/admin/api/v1`);
    });
    ...
    describe('#doesUrlBelongToService()', () => {
      it('returns true when url belongs to this service', () => {
        ...
        assert.isTrue(atlasService.doesUrlBelongToService(`${process.env.ATLAS_SERVICE_URL || 'https://atlas-a.wbx2.com'}/admin/api/v1`));
      });
    });
