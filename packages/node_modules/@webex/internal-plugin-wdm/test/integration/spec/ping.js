...
describe('plugin-wdm', function () {
  describe('Device', () => {
    ...
    describe('.services', () => {
      ...
      before('register device', () => webex.internal.device.register());
      ...
      describe('each service written after the test suite was created', () => {
        flaky(it, process.env.SKIP_FLAKY_TESTS)('responds to pings', () => Object.keys(webex.internal.device.services)
