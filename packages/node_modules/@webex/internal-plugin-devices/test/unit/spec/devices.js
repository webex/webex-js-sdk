...
describe('plugin-devices', () => {
  describe('Devices', () => {
    ...
    beforeEach('initialize webex with the devices plugin', () => {
      ...
      webex.internal.devices.set(clonedDTO);
      ...
      describe('when an network inactivity property changes', () => {
        ...
        describe('when the \'inNetworkInactivityDuration\' changes', () => {
          beforeEach('change \'inNetworkInactivityDuration\'', () => {
            devices.inNetworkInactivityDuration = 1234;
          });
