...
import {
  ...
  DEVICES_EVENT_REGISTRATION_SUCCESS
} from './constants';
...
const Devices = WebexPlugin.extend({
    ...
    if (wait) {
      return services.waitForCatalog(
        ...
        .then(() => (
          ...
          services.get('wdm') ?
            Promise.resolve() :
            Promise.reject(new Error('`wdm` service is not available'))
        ));
    }
  ...
  processRegistrationSuccess(response) {
    ...
    this.trigger(DEVICES_EVENT_REGISTRATION_SUCCESS, this);
  },
  ...
  waitForRegistration(timeout = 10) {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.once(DEVICES_EVENT_REGISTRATION_SUCCESS, () => {
