...
options
  ...
  minActivities: the minimum number of activities you would like in your batch

  queryType: the direction to fetch activities. One of 'newer', 'older', 'mid'

  search: a server activity object to return as the middle point of the batch, along with its surrounding activities
