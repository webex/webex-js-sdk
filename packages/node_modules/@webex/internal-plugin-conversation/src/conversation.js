  ...
  get(conversation, options) {
    return this._inferConversationUrl(conversation)
      .then(() => {
        ...
        // which makes the payload lighter by removing participat info
        // If the caller explicitly sets the participantAckFilter we
        // don't want that default setting.
        if ('participantAckFilter' in options) {
