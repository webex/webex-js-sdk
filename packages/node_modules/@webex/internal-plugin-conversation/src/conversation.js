...
const Conversation = WebexPlugin.extend({
   ...
   * @returns {Promise}
   */
  // It's building a string resourceUri + "/authorizations?authId=" + id, where resourceUri is the meeting container's KRO URL, and id is the conversation's KRO URL.
  delete(conversation, object, activity) {
    ...
    // resourceUri + "/authorizations?authId=" + id, where resourceUri is the meeting container's KRO URL, and id is the conversation's KRO URL.
    return this.prepare(activity, {
      verb: 'delete',
      target: this.prepareConversation(convoWithUrl),
      ...
      kmsMessage: {
        method: 'delete',
        uri: `${object.object.kmsResourceObjectUrl}/authorizations?${querystring.stringify({authId: convoWithUrl.kmsResourceObjectUrl})}`
      }
    })
      .then((a) => this.submit(a));
  },
