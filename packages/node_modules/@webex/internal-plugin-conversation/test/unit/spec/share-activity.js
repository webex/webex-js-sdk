  ...
  describe('ShareActivity', () => {
    ...
    describe('#upload', () => {
      ...
      it('checks whether property role:spaceAvatar is sent in body while making a call to /finish API', () => {
        const _upload = sinon.spy(webex._upload);    
        const file = {
          lastModified: 1625040108004,
          lastModifiedDate: 'Wed Jun 30 2021 10:01:48 GMT+0200 (Central European Summer Time) {}',
          name: 'mordor.jpeg',
          size: 113346,
          type: 'image/jpeg',
          webkitRelativePath: ''
        ...
        _upload(file, fakeURL , uploadOptions);

        assert.isTrue(_upload.calledWith(file, fakeURL , uploadOptions));
      });
    });
