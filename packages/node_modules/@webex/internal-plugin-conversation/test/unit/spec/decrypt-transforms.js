...
describe('plugin-conversation', () => {
  describe('decryption transforms', () => {
    ...
    describe('link activity', () => {
      ...
      /* it('decrypts a meeting container activity', () => {
        const transform = transforms.find((t) => t.name === 'decryptActivity');
        const transformStub = sinon.spy();
        ...
        const meetingContainer = {
          ...
          url: 'https://meeting-container-a.wbx2.com/meeting-container/api/v1/containers/d5416be0-aeb9-11ec-bac4-ad7fbcfb8ba2',
          published: '2022-03-28T17:09:31.167Z',
