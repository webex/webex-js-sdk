    ...
    describe('#makeShare', () => {
      ...
      it('shares a file to a thread', () => {
        ...
        return spark.internal.conversation.share(conversation, share)
          .then((activity) => {
            assert.equal(activity.object.displayName, 'a name');
            const threadShare = spark.internal.conversation.makeShare(conversation);
            ...
            return spark.internal.conversation.share(conversation, threadShare);
          })
          .then((activity) => {
            assert.equal(activity.parentActivityId, parentActivityId);
            assert.equal(activity.activityType, 'reply');
