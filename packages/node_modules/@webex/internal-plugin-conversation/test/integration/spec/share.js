...
describe('plugin-conversation', function () {
  ...
  describe('share', () => {
    ...
    const sampleGif = 'happy best gif GIF.gif';
    ...
    describe('#share()', () => {
      ...
      describe('when it shares a transcodable file', () => {
        ...
        it('mercury receives an update', () => webex.internal.conversation.share(conversation, {
          object: {
    ...
    describe('#addGif', () => {
      ...
      browserOnly(it)('if the giphy does not exist, then we check it gets added to this.uploads', (done) => {
        ...
        Object.defineProperty(file, 'giphyURL', {value: originalGiphyURL});
        Object.defineProperty(file, 'thumbnailURL', {value: originalGiphyStillURL});
