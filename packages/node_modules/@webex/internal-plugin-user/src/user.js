...
const User = WebexPlugin.extend({
  ...
  /**
   * Fetches details about the current user from CI
   * @returns {Promise<Object>}
   */
  getCIUserInfo() {
    return this.request({
      service: 'identity',
      resource: 'identity/scim/v1/Users/me'
    })
      .then((res) => res.body)
      .then(tap((user) => {
        // CI endpoint doesn't use the same user format as actors,
        // primary email comes from userName
