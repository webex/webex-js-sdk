...
describe('Encryption', function () {
  ...
  describe('KMS', () => {
    ...
    describe('#fetchKey(onBehalfOf)', () => {
      ...
      it('error retrieving key, on behalf of another user, without webex.kms_orgagent role',
        () => spock.webex.internal.encryption.kms.createUnboundKeys({count: 1})
          ...
          .then(() => {
            expect.fail('It should not be possible to retrieve a key on behalf of another user without the webex.kms_orgagent role');
          })
          .catch((error) => {
