 ...
 * @throws if kty is not a valid type
 * @returns {null}
 */
 ...
 * the Common Name
 * @params {Certificate} certificate represents the KMS
 * @param {Object} JWT KMS credentials
 * @param {string} JWT.kid the uri of the KMS
 * @throws if unable to validate certificate against KMS credentials
 * @returns {null}
 */
 ...
 * @throws if e or n doesn't match the first certificate
 * @returns {null}
 */
...
/**
 * Validates the information provided by the KMS
