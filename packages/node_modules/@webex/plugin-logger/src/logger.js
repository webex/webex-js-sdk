...
const Logger = WebexPlugin.extend({
  ...
  getCurrentClientLevel() {
    ...
    if (this.config.client_level) {
      return this.config.client_level;
    }
   ...
   */
  formatLogs() {
    // TODO: revisit the type of date field - keep as Date until format stage? that could make merge more efficient
