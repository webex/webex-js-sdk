...
describe('plugin-teams', function () {
  ...
  describe('#teams', () => {
    ...
    describe('#list()', () => {
      ...
      before(() => webex.teams.create({name: 'Cisco Spark Test Team 1'})
        .then((team) => {
          team1 = team;
        }));

      before(() => webex.teams.create({name: 'Cisco Spark Test Team 0'})
        .then((team) => {
          team0 = team;
        }));
    ...
    describe('#update()', () => {
      it('updates a single team\'s name', () => webex.teams.create({
        ...
        .then((team) => {
          ...
          return webex.teams.update(Object.assign({}, team, {name: 'Cisco Spark Test Team (Updated)'}));
        })
        .then((team) => {
          assert.isTeam(team);
