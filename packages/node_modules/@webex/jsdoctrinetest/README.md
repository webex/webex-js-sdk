...
> Mocha plugin which parses source code for doc blocks containing assertions and
> runs them as mocha specs.
...
The following command will create a run a mocha spec asserting the result of
`fn()` is `true`.
