...
const Presence = SparkPlugin.extend({
   ...
   */
  enable() {
    return this.spark.internal.feature.setFeature(USER, USER_PRESENCE_ENABLED, true)
   ...
   */
  disable() {
    return this.spark.internal.feature.setFeature(USER, USER_PRESENCE_ENABLED, false)
      .then((response) => response.value);
  },
   ...
   */
  isEnabled() {
    return this.spark.internal.feature.getFeature(USER, USER_PRESENCE_ENABLED);
  },
