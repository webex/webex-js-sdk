...
describe('plugin-presence', function () {
  ...
  describe('Presence', () => {
    ...
    describe('#enable()', () => {
      it('enables presence', () => spock.spark.internal.presence.enable()
        .then((isEnabled) => {
          assert.equal(isEnabled, true);
        })
        .then(() => spock.spark.internal.presence.isEnabled())
        .then((isEnabled) => {
          assert.equal(isEnabled, true);
        }));
    });
    ...
    describe('#disable()', () => {
      it('disables presence', () => spock.spark.internal.presence.disable()
        .then((isEnabled) => {
    ...
    describe('#isEnabled()', () => {
      it('returns true when presence is enabled', () => spock.spark.internal.presence.enable()
        .then(() => spock.spark.internal.presence.isEnabled())
        .then((isEnabled) => {
          assert.equal(isEnabled, true);
        }));

      it('returns false when presence is disabled', () => spock.spark.internal.presence.disable()
        .then(() => spock.spark.internal.presence.isEnabled())
        .then((isEnabled) => {
          assert.equal(isEnabled, false);
        }));
