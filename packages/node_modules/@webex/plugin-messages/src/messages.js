...
const Messages = WebexPlugin.extend({
   ...
   * The events sent to the handlers will resemble the payload
   * of the webhook for the same event
   * @instance
   * @memberof Messages
   * @returns {Promise}
   * @example
  ...
  /**
   * Stop listening to internal room events
   * Call this as part of cleanup, or when you no longer want
   * to process room events
   * @instance
   * @memberof Messages
   * @returns {void}
   * @example
   * webex.messsages.stopListening();
