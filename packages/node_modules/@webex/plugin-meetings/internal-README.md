...
- [Sign into NPM](https://docs.npmjs.com/private-modules/ci-server-config#how-to-create-a-new-authentication-token) so taht you can install the private package `@ciscospark/test-helper-test-users`. This package generates temporary test users.
