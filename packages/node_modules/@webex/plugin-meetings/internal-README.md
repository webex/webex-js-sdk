...
The Meetings Plugin does not currently utilize any form of H264 encoding dependency validation. We recommend implementing H264 encoding dependency validation prior to initializing the JS SDK to prevent any errors from occuring on devices that do not have the H264 encoding browser dependency available before the page is loaded.
