...
import {MEETINGS, DATA} from '../constants';
...
export default class MeetingStats extends StatelessSparkPlugin {
  ...
  constructor(attrs, options, optionalCreateOptions) {
    ...
    if (optionalCreateOptions && optionalCreateOptions.filter && !optionalCreateOptions.stream && optionalCreateOptions.media) {
      this.withFilter(optionalCreateOptions.filter, optionalCreateOptions.media);
    }
    if (optionalCreateOptions && optionalCreateOptions.stream && !optionalCreateOptions.filter && optionalCreateOptions.media) {
   ...
   * @param {RTCRtpSender|RTCRtpReceiver} transceiverDirection
   * @param {RTCPeerConnection} peerConnection
   * @returns {MeetingStats}
   */
  withStream(transceiverDirection, peerConnection) {
    const stream = new StatsStream(transceiverDirection, peerConnection);
