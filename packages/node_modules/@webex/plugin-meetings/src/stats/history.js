...
export default class StatsHistory {
  ...
  /**
   * adds a history entry into the array at the head, removes from the tail if too large, returns the old tail if removed
   * @param {Object} data filtered stats report to add to the history array
   * @returns {Object} the removed stats report at the end that had to be removed for the new stats data report to be added to the front
   */
  addHistory(data) {
    let removed;
