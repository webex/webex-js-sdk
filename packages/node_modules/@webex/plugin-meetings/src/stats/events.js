    ...
    if (data && data.data && data.data.getData()) {
      ...
      if (operate && !this.receivedFirstAudioBytes) {
        ...
        if (somethingMatched && somethingMatched.found && somethingMatched.match) {
          ...
          this.emit(EVENTS.STATS_UPDATE, {file: 'stats/events', function: 'receiveEventAudio'}, this.receivedFirstAudioBytes);
        }
      }
    }
    ...
    if (data && data.data && data.data.getData()) {
      ...
      if (operate && !this.receivedFirstVideoBytes) {
        ...
        if (somethingMatched && somethingMatched.found && somethingMatched.match) {
          ...
          this.emit(EVENTS.STATS_UPDATE, {file: 'stats/events', function: 'receiveEventVideo'}, this.receivedFirstVideoBytes);
        }
      }
    }
    ...
    if (data && data.data && data.data.getData()) {
      ...
      if (operate && !this.sentFirstVideoBytes) {
        ...
        if (somethingMatched && somethingMatched.found && somethingMatched.match) {
          ...
          this.emit(EVENTS.STATS_UPDATE, {file: 'stats/events', function: 'sendEventVideo'}, this.sentFirstVideoBytes);
        }
      }
    }
    ...
    if (data && data.data && data.data.getData()) {
      ...
      if (operate && !this.sentFirstAudioBytes) {
        ...
        if (somethingMatched && somethingMatched.found && somethingMatched.match) {
          ...
          this.emit(EVENTS.STATS_UPDATE, {file: 'stats/events', function: 'sendEventAudio'}, this.sentFirstAudioBytes);
        }
      }
    }
