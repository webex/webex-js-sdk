    ...
    if (data && data.data && data.data.getData()) {
      ...
      if (operate && !this.receivedFirstAudioBytes) {
        ...
        if (somethingMatched && somethingMatched.found && somethingMatched.match) {
          ...
          Trigger.trigger(this, EVENT_TRIGGERS.STATS_UPDATE, this.receivedFirstAudioBytes);
        }
      }
    }
    ...
    if (data && data.data && data.data.getData()) {
      ...
      if (operate && !this.receivedFirstVideoBytes) {
        ...
        if (somethingMatched && somethingMatched.found && somethingMatched.match) {
          ...
          Trigger.trigger(this, EVENT_TRIGGERS.STATS_UPDATE, this.receivedFirstVideoBytes);
        }
      }
    }
    ...
    if (data && data.data && data.data.getData()) {
      ...
      if (operate && !this.sentFirstVideoBytes) {
        ...
        if (somethingMatched && somethingMatched.found && somethingMatched.match) {
          ...
          Trigger.trigger(this, EVENT_TRIGGERS.STATS_UPDATE, this.sentFirstVideoBytes);
        }
      }
    }
    ...
    if (data && data.data && data.data.getData()) {
      ...
      if (operate && !this.sentFirstAudioBytes) {
        ...
        if (somethingMatched && somethingMatched.found && somethingMatched.match) {
          ...
          Trigger.trigger(this, EVENT_TRIGGERS.STATS_UPDATE, this.sentFirstAudioBytes);
        }
      }
    }
