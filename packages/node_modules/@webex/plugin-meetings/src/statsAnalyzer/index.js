...
export default class StatsAnalyzer extends EventsScope {
  ...
  getStatsAndParse() {
    ...
    this.emit(
      {
        file: 'statsAnalyzer',
        function: 'getStatsAndParse'
      },
      EVENT_TRIGGERS.MEDIA_STATS,
      {
        stats: this.lastStatsResults
      }
    );
  ...
  processOutboundRTPResult(result, type) {
    ...
    if (result.bytesSent) {
      ...
      this.statsResults[mediaType][sendrecvType].framesEncodedPerSecond = (result.framesEncoded - this.statsResults.internal[mediaType][sendrecvType].framesEncoded) / this.config.analyzerInterval;
      ...
      this.statsResults[mediaType][sendrecvType].framesEncodedPerSecond = (result.framesEncoded - this.statsResults[mediaType][sendrecvType].framesEncoded) / this.config.analyzerInterval;
  ...
  processInboundRTPResult(result, type) {
    ...
    if (result.bytesReceived) {
      ...
      this.statsResults[mediaType][sendrecvType].totalNackCount = result.nackCount;
      this.statsResults[mediaType][sendrecvType].totalPliCount = result.pliCount;
      this.statsResults[mediaType][sendrecvType].framesDecodedPerSecond = (result.framesDecoded - this.statsResults[mediaType][sendrecvType].framesDecoded) / this.config.analyzerInterval;
