...
export default class StatsAnalyzer extends EventsScope {
  ...
  constructor(config) {
    ...
    this.lastPacketLoss = {video: {recv: [], send: []}};
  }
  ...
  sendMqaData() {
    ...
    this.lastPacketLoss.video.send.push(videoSender.common.remoteLossRate);
    this.lastPacketLoss.video.recv.push(videoReceiver.common.mediaHopByHopLost);

    console.log('remote packet loss TX ', videoSender.common.remoteLossRate);
    console.log('remote packet loss RX ', videoReceiver.common.mediaHopByHopLost);
  ...
  processInboundRTPResult(result, type) {
    ...
    if (result.bytesReceived) {
      ...
      this.statsResults[mediaType][sendrecvType].currentPacketLossRatio = this.statsResults[mediaType][sendrecvType].currentPacketsLost / this.statsResults[mediaType][sendrecvType].packetsReceived;
