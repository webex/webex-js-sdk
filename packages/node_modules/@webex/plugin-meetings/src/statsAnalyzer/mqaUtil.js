...
export const getAudioSenderMqa = ({audioSender, statsResults, lastMqaDataSent}) => {
  ...
  audioSender.common.remoteJitter = statsResults[mediaType][sendrecvType].remoteJitter * 1000;
...
export const getVideoReceiverMqa = ({videoReceiver, statsResults, lastMqaDataSent}) => {
  ...
  videoReceiver.streams[0].common.endToEndLost = totalPacketLoss;// TODO: calculate the value
  ...
  videoReceiver.streams[0].common.transmittedBitrate = totalBytesReceivedInaMin ? (totalBytesReceivedInaMin) * 8 / 60 : 0;
...
export const getVideoSenderMqa = ({videoSender, statsResults, lastMqaDataSent}) => {
  ...
  videoSender.common.remoteJitter = statsResults[mediaType][sendrecvType].remoteJitter * 1000;
  ...
  console.log('Packets send ', videoSender.common.rtpPackets);
  console.log('Total packets lost ', totalpacketsLostForaMin);
