...
class Metrics {
   ...
   * @param {object} sparkVersion spark version
   * @returns {object} null
   */
  initialSetup(meetingCollection, sparkVersion) {
  ...
  getUserAgentInfo() {
    ...
    if (userAgentOption) {
      ...
      return util.format('SparkWeb/%s %s', `${process.env.NODE_ENV}-${this.sparkVersion}`, userAgentOption);
    }

    // TODO:  add version of the SDK
    return util.format('SparkWeb/%s', `${process.env.NODE_ENV}-${this.sparkVersion}`);
  }
