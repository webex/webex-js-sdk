 ...
 */
  ...
  getUserAgentInfo() {
    ...
    if (userAgentOption) {
      ...
      return util.format('webexJsSdk/%s %s', `${process.env.NODE_ENV}-${this.webexVersion}`, userAgentOption);
    }

    return util.format('webexJsSdk/%s', `${process.env.NODE_ENV}-${this.webexVersion}`);
  }
}
