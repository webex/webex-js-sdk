...
class MQAProcessor {
   ...
   */
  process(id, interval) {
    let rtcCandidatePair, rtcOutVideo, rtpOutVideo, remoteVideo; // TODO: , rtcInVideo, rtpInVideo, rtcOutAudio, rtcInAudio, rtpInAudio, rtpOutAudio; // TODO:
    let vsTransmit;
    ...
    switch (id) {
      ...
      case STATS.SHARE_SENDER_ID:
        if (sumValue) {
          ...
          remoteVideo = sumValue.remoteVideo;
        }
        ...
        if (bowser.name.toLowerCase() === 'firefox') {
          ...
          // TODO: place properly in the MQA object and ensure correct keys
          vsTransmit.common.remoteJitter = remoteVideo ? remoteVideo.jitter : -1;
          vsTransmit.common.rtpEndToEndLost = remoteVideo ? remoteVideo.packetsLost : -1;
        }
