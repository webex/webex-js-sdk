...
export default ({
  eventType: {
    ...
    CLIENT_PSTN_AUDIO_ATTEMPT_START: 'client.pstnaudio.attempt.start',
    CLIENT_PSTN_AUDIO_ATTEMPT_FINISH: 'client.pstnaudio.attempt.finish',
    CLIENT_PSTN_AUDIO_ATTEMPT_SKIP: 'client.pstnaudio.attempt.skip'
  },
...
export const errorCodes = {
  ...
  CLIENT_TEMP_ID_ALREADY_EXISTS: 1409001,
