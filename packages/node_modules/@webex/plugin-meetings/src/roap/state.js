...
const shouldStep = (roap, meeting) => {
  ...
  if (meeting) {
    ...
    if (!meeting.mediaProperties.mediaPeerConnection && !meeting.mediaProperties.sharePeerConnection && messageType === _ANSWER_) {
      return false;
    }
  }
      ...
      transitions: [
        {
          ...
          to(signal, meeting) {
            ...
            if (!shouldStep(this.roapRef, meeting)) {
              return value;
            }
      ...
      methods: {
        ...
        onAfterStep(transition) {
          LoggerProxy.logger.log(
            `RoapStateMachine->onAfterStep#${transition.event} fired! State changed from '${transition.from}' to '${
              transition.to
