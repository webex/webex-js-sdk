...
export default class RoapRequest extends StatelessSparkPlugin {
  ...
  joinMeetingWithRoap(options) {
    ...
    return Promise.resolve().then(() => {
      ...
      if (options.locusUrl) {
        ...
        throw new ParameterError(new Error('Must provide a locusUrl or sipTarget'));
      }
  ...
  sendRoap(options) {
    const {
      roapMessage, locusSelfUrl, mediaId, correlationId, callFlowId
    } = options;
    ...
    Metrics.sendMediaRequest({meetingId: callFlowId});
    ...
    return this.spark
      ...
      .then((res) => {
        Metrics.gotMediaResponse({meetingId: callFlowId});
      ...
      .catch((err) => {
        Metrics.gotMediaResponse({meetingId: callFlowId, data: {error: Metrics.parseLocusError(err, true)}});
