...
const RoapHandler = {
  ...
  save(roap) {
    ...
    if (roap.msg.messageType === 'ERROR' && roap.msg.errorType === 'CONFLICT') {
      ...
      PeerConnectionManager.rollBackLocalDescription({peerConnection: meeting.peerConnection})
        .then(() => {
  ...
  performState(session, meeting) {
    ...
    switch (session.state) {
      ...
      case RoapConstants.RoapState.WAIT_TX_ANSWER:
        ...
        if (
          (meeting.pc && meeting.pc.signalingState === 'have-local-offer')
