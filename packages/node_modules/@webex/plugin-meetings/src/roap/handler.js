...
const compareRemoteRoapOffer = (lastRoapMessage, currentRoapMessage) => lastRoapMessage?.msg?.seq === currentRoapMessage.msg.seq && lastRoapMessage?.msg?.messageType === currentRoapMessage.msg.messageType;
  ...
  perform(session, meeting, action) {
    switch (session.state.state) {
      case ROAP.ROAP_STATE.INIT:
        this.roapFinished(meeting.correlationId);
        break;
