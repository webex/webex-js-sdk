...
export default class Roap extends StatelessWebexPlugin {
  ...
  roapEvent(data) {
    ...
    const marisdp = msg.sdps.toString();

    if (marisdp && marisdp.match(/cisco-mari/gm) && marisdp.match(/cisco-mari/gm).length > 0) {
      return;
    }
 ...
 * @param {correlationId} correlationId of the meeting affected
 * @returns {undefined}
 * @private
 * @memberof Roap
 */
roapFinished(correlationId) {
