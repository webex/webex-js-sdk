...
const Roap = SparkPlugin.extend({
  namespace: 'Meetings',
  children: {
    roapHandler: RoapHandler,
    roapAdapter: RoapAdapter
  },

  sendRoapOK(options) {
    const meeting = this.spark.meetings.meetingCollection.get(options.correlationId);
  ...
  sendRoapError(session, locus, errorType) {
    ...
    this.roapAdapter.sendRoap(msg, locus);
  },
