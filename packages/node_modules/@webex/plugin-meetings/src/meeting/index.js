...
export default class Meeting extends StatelessSparkPlugin {
  ...
  /**
   * get local media streams based on options passed
   * @param {Object} audio the audio device {deviceId: {exact: X}}
   * @param {Object} video the video device {deviceId: {exact: X}}
   * @returns {Promise} see #Media.getUserMedia
   * @public
   * @todo should be static
   * @memberof Meeting
   */
  getMediaStreamsDevices = (audio, video) => Media.getMedia(audio, video);
