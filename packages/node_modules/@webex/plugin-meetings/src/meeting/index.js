      ...
      .then(() => Media.attachMedia(this.mediaProperties, {
        ...
        .then((peerConnection) => {
          ...
          if (this.config.stats.enableStatsAnalyzer) {
            ...
            this.statsAnalyzer.on(EVENT_TRIGGERS.MEDIA_STATS, (result) => {
              Trigger.trigger(
                this,
                {
                  file: 'meeting/index',
                ...
                EVENT_TRIGGERS.MEDIA_STATS,
                {
                  video: {
                    send: {
                      width: result.stats.resolutions.video.send.width,
                      height: result.stats.resolutions.video.send.height,
                      fps: result.stats.video.send.framesEncodedPerSecond * 1000,
                      loss: result.stats.video.send.currentPacketLossRatio
                    },
                    recv: {
                      width: result.stats.resolutions.video.recv.width,
                      height: result.stats.resolutions.video.recv.height,
                      fps: result.stats.video.recv.framesDecodedPerSecond * 1000,
                      loss: result.stats.video.recv.currentPacketLossRatio
                    }
                  },
                  share: {
                    send: {
                      width: result.stats.resolutions.share.send.width,
                      height: result.stats.resolutions.share.send.height,
                      fps: result.stats.share.send.framesEncodedPerSecond * 1000,
                      loss: result.stats.share.send.currentPacketLossRatio
                    },
                    recv: {
                      width: result.stats.resolutions.share.recv.width,
                      height: result.stats.resolutions.share.recv.height,
                      fps: result.stats.share.recv.framesDecodedPerSecond * 1000,
                      loss: result.stats.share.recv.currentPacketLossRatio
                    }
                  }
                }
              );
