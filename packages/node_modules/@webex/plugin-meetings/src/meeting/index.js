...
export default class Meeting extends StatelessSparkPlugin {
  ...
  parseMeetingInfo(meetingInfo) {
    ...
    if (meetingInfo && !(meetingInfo.errors && meetingInfo.errors.length > 0)) {
      this.convoId = meetingInfo.convoId || this.convoId;
      this.locusUrl = meetingInfo.locusUrl || this.locusUrl;
      this.sipUri = meetingInfo.sipMeetingUri || this.sipUri;
      this.owner = meetingInfo.owner || this.owner;
    }
  }
  ...
  addMedia(options = {}) {
    ...
    this.mediaProperties.setMediaDirection(process.env.NODE_ENV === 'test' ? {} : Object.assign(this.config.mediaSettings, options.mediaSettings));
