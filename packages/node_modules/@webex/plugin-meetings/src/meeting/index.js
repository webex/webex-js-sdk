...
export default class Meeting extends StatelessWebexPlugin {
  ...
  */
   ...
   * @memberof Meeting
   */
  getMediaStreams = (mediaDirection, audioVideo = {}) => {
    if (mediaDirection && (mediaDirection.sendAudio || mediaDirection.sendVideo || mediaDirection.sendShare)) {
      return Media.getUserMedia(mediaDirection, audioVideo)
        .then((response) => {
    ...
    return MeetingUtil.validateOptions(options)
      ...
      .then(() => Media.attachMedia(this.mediaProperties, this.id)
        ...
        .then(() => new Promise((resolve, reject) => {
          ...
          const joiningTimer = setInterval(function () {
            timerCount += 1;
        ...
        .then(() => this.roap
          ...
          .then(() => {
            console.log('send share request ', new Date());
          })
          .catch((err) => {
