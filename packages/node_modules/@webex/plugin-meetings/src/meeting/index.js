...
import {MEETINGS, EVENT_TRIGGERS, EVENT_TYPES, EVENTS, FLOOR_ACTION, BUSY, INCOMING, STOP, ONLINE, ONE_ON_ONE, CONTENT, ROAP_SEQ_PRE, LOCUSINFO} from '../constants';
...
export default class Meeting extends StatelessSparkPlugin {
  ...
  leave() {
    ...
    return this.meetingRequest
      ...
      .then((response) => this.locusInfo.onFullLocus(response.body.locus))
