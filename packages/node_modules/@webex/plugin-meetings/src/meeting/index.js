...
import {MEETING_STATE_MACHINE, MEETING_VIDEO_STATE_MACHINE, MEETINGS, EVENT_TRIGGERS, EVENT_TYPES} from '../constants';
...
export default class Meeting extends StatelessSparkPlugin {
  ...
  constructor(attrs, options) {
    ...
    this.audio = AudioStateMachine.create();
    this.video = VideoStateMachine.create();
  ...
  getAudioSelf() {
    return this.audio.getSelf();
  }

  getVideoMuted() {
    return this.video.getMuted();
  }

  getVideoSelf() {
    return this.video.getSelf();
  }
  ...
  startAudioVideo(mediaDirection) {
    this.audio.init({mute: !mediaDirection.sendAudio, self: true}, this);
    this.video.init({mute: !mediaDirection.sendVideo, self: true}, this);
  }
  ...
  join(options) {
    ...
    this.startAudioVideo(mediaDirection);
  ...
  toggleVideo(options) {
    this.video.toggle(options, this);
  }
   ...
   */
  toggleAudio(options) {
    this.audio.toggle(options, this);
  }
