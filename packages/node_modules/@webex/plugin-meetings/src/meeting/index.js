...
export default class Meeting extends StatelessSparkPlugin {
  ...
  updateMeetingObject(object) {
    ...
    // LoggerProxy.logger.log(` ${this.name} Meeting:index->updateMeeting#Meeting updated with ${JSON.stringify(object)}`);
  ...
  muteAudio() {
    ...
    return this.audio.toggle({
      ...
      .catch((e) => {
        console.error('ERROR AUDIO MUTE ', e);
      });
  }
  ...
  share() {
    ...
    if (content) {
      console.log('SHARE MEETING ', JSON.stringify(this.locusInfo.self));
      console.log('LOCUS MEETING ', this.locusInfo.url);
      console.log('MEETING deviceUrl', this.deviceUrl);
      console.log('MEETING spark deviceUrl', this.spark.internal.device.url);
   ...
   */
  startRecording() {
    return MeetingUtil.startRecording(this.locusUrl, this.locusInfo);
  }
   ...
   */
  stopRecording() {
    return MeetingUtil.stopRecording(this.locusUrl, this.locusInfo);
  }
   ...
   */
  pauseRecording() {
    return MeetingUtil.pauseRecording(this.locusUrl, this.locusInfo);
  }
   ...
   */
  resumeRecording() {
    return MeetingUtil.resumeRecording(this.locusUrl, this.locusInfo);
  }
