...
import {MEETINGS, EVENT_TRIGGERS, EVENT_TYPES, EVENTS, FLOOR_ACTION, BUSY, INCOMING, STOP, ONLINE, ONE_ON_ONE, CONTENT, ROAP_SEQ_PRE} from '../constants';
...
export default class Meeting extends StatelessSparkPlugin {
  ...
  setUpLocusInfoSelfListener() {
    this.locusInfo.on(EVENTS.SELF_UNADMITTED_GUEST, (payload) => {
      if (payload) {
    ...
    this.locusInfo.on(EVENTS.SELF_ADMITTED_GUEST, (payload) => {
      if (payload) {
