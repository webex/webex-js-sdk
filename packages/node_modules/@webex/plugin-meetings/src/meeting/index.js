...
import {MEETINGS, EVENT_TRIGGERS, EVENT_TYPES, EVENTS, FLOOR_ACTION, BUSY, INCOMING, ONLINE, ONE_ON_ONE, CONTENT, _JOIN_, LOCUSINFO, MEETING_STATE, MEETING_STATE_MACHINE} from '../constants';
...
export default class Meeting extends StatelessSparkPlugin {
  ...
  setUpLocusInfoMeetingListener() {
    this.locusInfo.on(EVENTS.REMOTE_ANSWERED_DECLINED, (payload) => {
      this.mtgState.ringStop(payload);
    });
