  ...
  */
  ...
  setRemoteStream(pc) {
    ...
    pc.ontrack = (event) => {
      ...
      const trackMediaID = event.transceiver.mid;
      let eventType = null;
      ...
      switch (trackMediaID) {
        case MEDIA_ID.AUDIO_TRACK:
          ...
          eventStream = MediaUtil.createMediaStream([event.track]);
          this.mediaProperties.setRemoteStream(eventStream);
          break;
        ...
        case MEDIA_ID.SHARE_TRACK:
          if (event.track) {
            ...
            eventStream = MediaUtil.createMediaStream([event.track]);
            this.mediaProperties.setRemoteShare(eventStream);
          }
          break;
        default: {
