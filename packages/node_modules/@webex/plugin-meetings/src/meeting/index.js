...
export default class Meeting extends StatelessWebexPlugin {
  ...
  */
  constructor(attrs, options) {
     ...
     * @memberof Meeting
     */
    this.setTimeoutFetchMeetingInfoId = null;
    /**
     * @instance
     * @type {String}
     * @readonly
    ...
    this.isFetchingMeetingInfo = false;
    /**
     * @instance
     * @type {Boolean}
     * @private
  ...
  async fetchMeetingInfo({
    ...
    console.log('fetchMeetingInfo Started');
    // this.isFetchingMeetingInfo = true;
    // when fetch meeting info is called directly by the client, we want to clear out the random timer for sdk to do it
    if (this.setTimeoutFetchMeetingInfoId) {
      clearTimeout(this.setTimeoutFetchMeetingInfoId);
    }
    // reset the setTimeout id to undefined
    this.setTimeoutFetchMeetingInfoId = undefined;
    ...
    try {
      ...
      this.isFetchingMeetingInfo = false;
      console.log('fetchMeetingInfo Finshed!');
    }
  }
  ...
  parseMeetingInfo(meetingInfo, destination = null) {
    ...
    const locusMeetingObject = typeof destination === 'object' ? destination : undefined;
