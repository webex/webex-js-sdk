...
export default class Meeting extends StatelessWebexPlugin {
  ...
  */
   ...
   * @param {Object} options leave options
   * @param {String} options.uuid the device with which to leave from, empty if just the computer
   * @returns {Promise}
   * @public
   * @memberof Meeting
   */
  endMeetingForAll(options = {}) {
    Metrics.postEvent({event: eventType.END, meeting: this, data: {trigger: trigger.USER_INTERACTION, canProceed: false}});

    LoggerProxy.logger.log('Meeting:index#end --> End meeting for All');

    return MeetingUtil.endMeetingForAll(this, options)
      .then((end) => {
