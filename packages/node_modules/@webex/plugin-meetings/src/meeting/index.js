...
export default class Meeting {
  ...
  _addMedia() {
    // Assuming we need audio video and share
    // but the configuration will change

    // step1:
    // getUserMedia or pass the streams from the developer
