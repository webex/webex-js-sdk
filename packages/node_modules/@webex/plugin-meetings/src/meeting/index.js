...
export default class Meeting extends StatelessSparkPlugin {
  ...
  setRoapSeq(seq) {
    if (seq) {
      console.warn(`UPDATING ROAP SEQ: ${seq}`);
      this.roapSeq = seq;
    }
  }
  ...
  setLocus(locus) {
    ...
    this.locusInfo.setup(locus.locus);
 ...
 */
  ...
  */
  ...
  addMedia(options = {}) {
    ...
    this.lastMediaDirection = Object.assign(this.config.mediaSettings, options.mediaSettings);
    // add a setup a function move the create and setup media in future
    // TODO: delete old audio and video if stale
    this.audio = this.audio || AudioStateMachine.create(this.lastMediaDirection, this);
    this.video = this.video || VideoStateMachine.create(this.lastMediaDirection, this);
    // this.state.local();
    this.setLocalStream(localStream);
    this.setLocalShare(localShare);
    return Media.attachMedia(this.lastMediaDirection, PeerConnectionManager, localStream, localShare, {mediaPeerConnection: this.mediaPeerConnection, sharePeerConnection: this.sharePeerConnection})
