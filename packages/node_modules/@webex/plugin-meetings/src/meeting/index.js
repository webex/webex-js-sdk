...
export default class Meeting extends StatelessWebexPlugin {
  ...
  */
  constructor(attrs, options) {
    ...
    /**
     * Correlation ID is set during join.
     * @instance
     * @type {String}
     * @readonly
     * @public
  ...
  join(options = {}) {
    ...
    // Correlation id is associated with a join attempt
    const correlationId = uuid.v4();

    this.setCorrelationId(correlationId);
    LoggerProxy.logger.info(`Meeting:index#join --> New correlation id has been generated, ${this.correlationId}`);
