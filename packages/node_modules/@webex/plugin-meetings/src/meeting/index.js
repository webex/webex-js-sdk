...
export default class Meeting extends StatelessSparkPlugin {
  ...
  moveFrom(resourceId) {
    ...
    // return MeetingUtil.joinMeetingOptions(this).then((join) => MeetingUtil.leaveMeeting(this, {resourceId, correlationId: oldCorrelationId, moveMeeting: true}).then((leave) => {
    //   Trigger.trigger(
    //     this,
    //     {
    //       file: 'meeting/index',
