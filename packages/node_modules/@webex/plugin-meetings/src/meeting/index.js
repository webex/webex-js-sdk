...
export default class Meeting extends StatelessWebexPlugin {
   ...
   * @param {Object} options.joinOptions - see #join() optional
   * @param {Object} options.mediaSettings - see #addMedia()
   * @param {Object} options.audioVideoOptions - see #getMediaStreams() optional
   ...
   * @param {Object} options.mediaSettings pass media options
    ...
    if (content && !this.isSharing) {
      ...
      return this.meetingRequest.changeMeetingFloor({
        ...
        .then(() => {
          ...
          Metrics.postEvent({event: eventType.SHARE_FLOOR_GRANTED_LOCAL, meeting: this});
        })
        .catch((e) => {
