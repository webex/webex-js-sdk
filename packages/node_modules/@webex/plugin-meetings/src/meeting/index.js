      ...
      .then(() => Media.attachMedia(this.mediaProperties, {
        ...
        .then(() => {
          ...
          return new Promise((resolve, reject) => {
            if (peerConnection.iceConnectionState === ICE_STATE.CONNECTED) {
            ...
            const stabilityTimeout = setTimeout(() => {
              if (peerConnection.iceConnectionState !== ICE_STATE.CONNECTED) {
                reject(new Error(`Peer Connection NOT CONNECTED after ${PC_BAIL_TIMEOUT / 1000} seconds since trying to join... Will now be ending the call`));
              }
              else {
                resolve(peerConnection);
              }
            ...
            this.on(EVENT_TRIGGERS.MEETING_MEDIA_CONNECTED, () => {
