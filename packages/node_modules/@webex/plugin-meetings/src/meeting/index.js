...
export default class Meeting extends StatelessSparkPlugin {
  ...
  constructor(attrs, options) {
    ...
    this.locusInfo = new LocusInfo(this.updateMeetingObject.bind(this), attrs.locus ? attrs.locus : {});
  ...
  */
  ...
  joinWithMedia(joinOptions, mediaOptions, streamsOptions) {
    this.join(joinOptions)
      .then((joinResponse) => this.getMediaStreams(streamsOptions)
        .then(([localStream, localShare]) => this.addMedia({
  ...
  acknowledge(type, ringing = true) {
    ...
    if (type === INCOMING) {
      return this.meetingRequest
        ...
        .then((response) => Promise.resolve(response)).then((response) => {
