...
export default class Meeting extends StatelessSparkPlugin {
  ...
  addMedia(options = {}) {
    ...
    return Media.attachMedia(this.mediaProperties, PeerConnectionManager, localStream, localShare, {
   ...
   * @memberof Meeting
   */
  postMedia(peerConnection) {
    this.setRemoteStream(this.mediaProperties.peerConnection);
  }
