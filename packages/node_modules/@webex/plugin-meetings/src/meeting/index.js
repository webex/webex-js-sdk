...
export default class Meeting extends StatelessWebexPlugin {
  ...
  */
  ...
  updateMedia(options = {}) {
    ...
    return MeetingUtil.validateOptions(options)
      ...
      .then(() => Media.updateMedia(this.mediaProperties, {
        ...
        .then(() => this.checkForStartStopShare(mediaSettings.sendShare, previousSendShareStatus)));
  }
   ...
   * @memberof Meeting
   */
  checkForStartStopShare(sendShare, previousShareStatus) {
  ...
  updateShare(options) {
    ...
    return MeetingUtil.validateOptions({sendShare, localShare: stream})
      ...
      .then(() => this.checkForStartStopShare(sendShare, previousSendShareStatus))
      .then(() => {
