 ...
 * @property resourceId optional
 * @property hostPin optional
 * @property moderator optional
 */
...
export default class Meeting extends StatelessWebexPlugin {
  ...
  */
   ...
   * @param {...JoinOptions} options.joinOptions - see #join() optional
   * @param {...MediaDirection} options.mediaSettings - see #addMedia()
   * @param {...AudioVideo} options.audioVideoOptions - see #getMediaStreams() optional
   ...
   * @param {...AudioVideo} audioVideo an optional audio/video object to set audioinput and videoinput devices, see #Media.getUserMedia
   ...
   * @param {MediaStream} stream optional
   * @returns {Promise}
   * @public
   * @memberof Meeting
   */
