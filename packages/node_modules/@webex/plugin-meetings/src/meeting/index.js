...
export default class Meeting extends StatelessSparkPlugin {
   ...
   * @param {RTCRtpSender|RTCRtpReceiver} options.audioSender
   * @param {RTCRtpSender|RTCRtpReceiver} options.audioReceiver
   * @param {RTCRtpSender|RTCRtpReceiver} options.videoSender
   * @param {RTCRtpSender|RTCRtpReceiver} options.videoReceiver
   * @param {RTCRtpSender|RTCRtpReceiver} options.shareSender
   * @param {RTCRtpSender|RTCRtpReceiver} options.shareReceiver
   * @returns {WebRTCStats}
   * @public
   * @memberof Meeting
   */
