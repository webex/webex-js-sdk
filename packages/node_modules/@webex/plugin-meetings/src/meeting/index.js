...
export default class Meeting extends StatelessWebexPlugin {
  ...
  */
   ...
   * @param {Boolean} options.preferTranscoding requests transcoding service from the Webex servers
   * @returns {Promise}
   * @public
   * @memberof Meeting
   */
  addMedia(options = {}) {
    ...
    const {
      localStream, localShare, mediaSettings, preferTranscoding = false
    } = options;
