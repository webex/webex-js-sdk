...
export default class Meeting {
   ...
   * @param {object} pairedDevice
   * @param {ISOString} startTime
   * @param {ISOString} endTime
   * @memberof Meeting
   */
  constructor({
    id, spaceID, members, peerConnections, health, type, direction, pairedDevice, startTime, endTime
  }) {
    this.id = id;
