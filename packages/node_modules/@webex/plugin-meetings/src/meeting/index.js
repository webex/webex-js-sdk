...
import {MEETINGS, EVENT_TRIGGERS, EVENT_TYPES, FLOOR_ACTION, BUSY, INCOMING, STOP, ONLINE} from '../constants';
...
export default class Meeting extends StatelessSparkPlugin {
  ...
  setLocus(locus) {
    ...
    this.locusInfo.intialSetup(locus.locus);
  ...
  */
  ...
  setPeerConnections(mediaPeerConnection, sharePeerConnection) {
    ...
    if (this.config.reconnection.detection) {
      ...
      // TODO: need to add a socket manager for reconnecting to mercury ? this is done in web client currently?
   ...
   */
  reconnect() {
    return ReconnectionManager.reconnect(this).then((reconnect) => {
