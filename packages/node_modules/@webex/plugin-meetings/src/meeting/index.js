...
export default class Meeting extends StatelessWebexPlugin {
  ...
  addMedia(options = {}) {
    if (MeetingUtil.isUnjoined(this.locusInfo) && !this.wirelessShare) {
      return Promise.reject(new MediaError(new Error(`To add media, the ${this.guest ? 'guest' : ''} user must be ${this.guest ? 'admitted. Wait to be admitted' : 'joined to the meeting'} to call addMedia`)));
    }
