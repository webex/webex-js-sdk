...
export default class Meeting extends StatelessWebexPlugin {
  ...
  */
  ...
  /**
   * emits media server avaliable , media server busy events
   * @param {boolean} busy mediaserver busy
   * @returns {void}
   * @private
   * @memberof Meeting
   */
  mediaBusyEvent = (busy) => {
    if (this.config.experimental.enableMediaBusyEvent) {
      if (busy) {
        LoggerProxy.logger.info('Meeting:mediaBusyEvent --> Media server busy negotating');
        Trigger.trigger(
          this,
          {
            file: 'meeting/index',
            function: 'mediaBusyEvent'
          },
          EVENT_TRIGGERS.MEDIA_SERVER_BUSY,
        );
      }
      else {
        LoggerProxy.logger.info('Meeting:mediaBusyEvent --> Media server avaliable');
        Trigger.trigger(
          this,
          {
            file: 'meeting/index',
          ...
          EVENT_TRIGGERS.MEDIA_SERVER_AVALIABLE,
        );
      }
    }
  }
