...
class MuteState {
  ...
  sendLocalMuteRequestToServer(meeting) {
    const audioMuted = (this.type === AUDIO) ? this.state.client.localMute : meeting.isAudioMuted();
    const videoMuted = (this.type === VIDEO) ? this.state.client.localMute : meeting.isVideoMuted();
