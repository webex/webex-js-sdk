...
export default class MeetingRequest extends StatelessWebexPlugin {
   ...
   * @returns {Promise}
   */
  async dialoutMeeting(options) {
    const {
      sipUri, deviceUrl, locusUrl, correlationId, dialout
    } = options;
    ...
    if (dialout) {
      body.device.dialoutAddress = dialout.invitee;
      body.device.url = `dialout:///${uuid.v4()}`;
    }
    ...
    return this
      ...
      .then((res) =>
      // MeetingServerActionCreators.onPstnConnected({
      //   locus,
      //   type: pstn.type,
      //   correlationId,
      //   pstn
      // });
        ...
        res)
      .catch((err) => {
        console.error('Call-sendMeetingRequest : ', err);
        console.error(`Call-sendMeetingRequest: errorBody ${JSON.stringify(body, null, 2)}`);
