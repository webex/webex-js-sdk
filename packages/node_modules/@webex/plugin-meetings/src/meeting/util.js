...
MeetingUtil.setPeerConnectionEvents = (meeting) => {
  ...
  const connectionFailed = () => {
    if (meeting.reconnectionManager.iceState.resolve) {
      // DISCONNECTED state triggres first then it goes to FAILED STATE
  ...
  peerConnection.onconnectionstatechange = () => {
    LoggerProxy.logger.log('Meeting:util#setPeerConnectionEvents --> CONNECTION STATE CHANGE.');
    switch (peerConnection.connectionState) {
      case CONNECTION_STATE.NEW:
        LoggerProxy.logger.log('Meeting:util#setPeerConnectionEvents --> CONNECTION STATE NEW.');
        break;
      case CONNECTION_STATE.CONNECTING:
        LoggerProxy.logger.log('Meeting:util#setPeerConnectionEvents --> CONNECTION STATE CONNECTING.');
        break;
      case CONNECTION_STATE.CONNECTED:
        LoggerProxy.logger.log('Meeting:util#setPeerConnectionEvents --> CONNECTION STATE CONNECTED.');
        break;
      case CONNECTION_STATE.CLOSED:
        LoggerProxy.logger.log('Meeting:util#setPeerConnectionEvents --> CONNECTION STATE CLOSED.');
        break;
      case CONNECTION_STATE.DISCONNECTED:
        LoggerProxy.logger.log('Meeting:util#setPeerConnectionEvents --> CONNECTION STATE DISCONNECTED.');
        break;
      case CONNECTION_STATE.FAILED:
        LoggerProxy.logger.log('Meeting:util#setPeerConnectionEvents --> CONNECTION STATE FAILED.');
  ...
  peerConnection.onclose = () => {
    // when ever peerconnection closes can happen when meeting ends but not destroyed or
    // user does a refresh browser
