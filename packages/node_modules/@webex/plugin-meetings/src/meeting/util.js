...
MeetingUtil.handleAudioLogging = (audioTrack) => {
  ...
  if (audioTrack) {
    ...
    LoggerProxy.logger.log(LOG_HEADER, deviceId);
...
MeetingUtil.handleDeviceLogging = (devices = []) => {
  ...
  devices.forEach((device) => {
    LoggerProxy.logger.log(LOG_HEADER, `deviceId = ${d.deviceId}`);
    LoggerProxy.logger.log(LOG_HEADER, 'settings', JSON.stringify(d));
  });
};
