...
export default {
  ...
  requestMeetingInfo(options) {
    ...
    if (type !== MeetingConstants.MeetingInfoType.LOCUS_ID) {
    ...
    return window.spark.request(requestParams)
      .then((res) => {
        self.requestFailCountMap.meetingInfo.resource = 0;
        res.body.correlationId = correlationId;
        return res;
      })
      .catch((err) =>
