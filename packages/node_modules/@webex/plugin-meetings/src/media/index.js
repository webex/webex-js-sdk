...
Media.getMedia = (audio, video) => {
  const mediaConfig = {
    audio,
    video: video ? {
      width: {ideal: config.meetings.resolution.idleWidth, max: config.meetings.resolution.maxWidth},
      height: {ideal: config.meetings.resolution.idleHeight, max: config.meetings.resolution.maxHeight}
    } : false
  };
