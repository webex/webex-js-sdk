...
export default class Media {
  ...
  constructor(devices, streams) {
    ...
    this.screenConstraints = getConstraints();
  }
...
*/
  // TODO: check if chrome supports plugin less share
  getScreenShare = (sendShare) => {
    ...
    if (bowser.chrome) {
      return screenShare.requestShare(['screen', 'window', 'tab'])
        .then((response) => {
          const videoConstraints = this.screenConstraints;
          videoConstraints.mandatory.chromeMediaSourceId = response.sourceId;
          return videoConstraints;
        })
        .catch((e) => {
          console.error('getScreenShare: Failed to get Screen share', e);
          return Promise.reject(e);
        });
    }

    return Promise.resolve(this.screenConstraints);
  };
