...
Media.reconnectMedia = (pc) => {
  if (pc.connectionState === PEER_CONNECTION_STATE.CLOSED ||
    pc.connectionState === PEER_CONNECTION_STATE.FAILED) {
    return Promise.reject(new Error('Reinitiate peerconnection'));
  }

  return PeerConnectionManager.createOffer(pc);
};
 ...
 * @param {Object} mappedPCs {peerConnection}
