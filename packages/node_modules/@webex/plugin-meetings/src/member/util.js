...
MemberUtil.isModeratorAssignmentNotAllowed = (participant) => participant && participant.moderatorAssignmentNotAllowed;
...
MemberUtil.isAudioMuted = (participant) => {
  if (!participant) {
    throw new ParameterError(new Error('Audio could not be processed, participant is undefined.'));
  }
...
MemberUtil.isVideoMuted = (participant) => {
  if (!participant) {
    throw new ParameterError(new Error('Video could not be processed, participant is undefined.'));
  }
...
MemberUtil.isRecording = (participant) => {
  if (!participant) {
    throw new ParameterError(new Error('Recording could not be processed, participant is undefined.'));
  }
