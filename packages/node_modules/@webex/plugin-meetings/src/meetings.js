...
export default class Meetings {
  ...
  initialize() {
    ...
    // TODO : create a PMR meeting object
    // TODO
    // this.pmr = requestMeetingInfo(this.spark.internal.device.userId, type);
   ...
   */
  create(destination) {
    const meetingInfo = null;
    return MeetingInfo.getMeetingInfo(destination)
      .then(() => {
        // handle response
      })
      .catch(() => {}) // handle errors
