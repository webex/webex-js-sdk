...
import {MEETINGS, LOCUSEVENT, LOCUS_ID} from '../constants';
  ...
  parse(meeting, data) {
    ...
    switch (eventType) {
      ...
      case LOCUSEVENT.CONTROLS_UPDATED:
        console.log('participantJoinLeft', eventType);
      ...
      case LOCUSEVENT.PARTICIPANT_ROLES_UPDATED:
        console.log('participantUpdated', eventType);
        //   this.participantUpdated(data);
        break;

      case LOCUSEVENT.PARTICIPANT_DECLINED:
        console.log('participantDeclined', eventType);
