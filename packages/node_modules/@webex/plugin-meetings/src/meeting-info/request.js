...
export default class MeetingInfoRequest extends StatelessWebexPlugin {
  ...
  fetchMeetingInfo(options) {
    if (!options || !options.type || !options.destination) {
      throw new ParameterError(new Error('MeetingInfo should be fetched with a type and destination specified, see list of valid types and their corresponding values in constants'));
    }
