...
MeetingInfoUtil.getDestinationType = async (from) => {
  ...
  if (MeetingInfoUtil.isMeetingLink(destination)) {
    ...
    LoggerProxy.logger.warn('Meeting-info:util#generateOptions --> (\'MeetingInfo is fetched with meeting link, sip uri, phone number, hydra room id, hydra people id, or a conversation url.');
...
MeetingInfoUtil.getRequestBody = (options) => {
  ...
  switch (type) {
    ...
    case _CONVERSATION_URL_:
      ...
      break;
    case _LOCUS_ID_:
      // use  the meeting info from the request
      break;
    case _MEETING_LINK_:
  ...
  // need to be added as part of the phase 1
  // body.permissionToken = value;
  // body.passwordToken = value;
