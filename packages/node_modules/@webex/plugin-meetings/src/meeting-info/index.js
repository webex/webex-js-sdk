...
export default class MeetingInfo extends StatelessSparkPlugin {
  ...
  constructor(attrs, options) {
    super({}, options);
    this.conversationServiceUrl = attrs.conversationServiceUrl;
   ...
   * @returns {Object} returns a meeting info object
   */
  fetchMeetingInfo(destination, type = null) {
    const options = MeetingInfoUtil.generateOptions({destination, type, conversationServiceUrl: this.conversationServiceUrl});
