...
export default class MeetingInfo extends StatelessSparkPlugin {
  ...
  fetchMeetingInfo(destination, type = null) {
    MeetingInfoUtil.conversationServiceUrl = this.spark.internal.device.services.conversationServiceUrl;
    const options = MeetingInfoUtil.generateOptions(destination, type);
