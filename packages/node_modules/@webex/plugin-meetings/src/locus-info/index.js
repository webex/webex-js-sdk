...
import {EVENTS, LOCUSEVENT, USER, CALL, MEETING_STATE, WEBEX_MEETING, LOCUSINFO} from '../constants';
...
export default class LocusInfo extends ChildEmitter {
  ...
  handleOneOnOneEvent(eventType) {
    if (this.parsedLocus.info.type === CALL) {
  ...
  isMeetingActive() {
    if (this.parsedLocus.fullState.type === CALL) {
