...
InfoUtils.parse = (info, roles) => {
  ...
  if (roles.includes(SELF_ROLES.COHOST)) {
    userDisplayHints = {...userDisplayHints, ...parsed.coHost, [DISPLAY_HINTS.LOWER_SOMEONE_ELSES_HAND]: true};
  }

  if (roles.includes(SELF_ROLES.MODERATOR)) {
    userDisplayHints = {...userDisplayHints, ...parsed.moderator, [DISPLAY_HINTS.LOWER_SOMEONE_ELSES_HAND]: true};
  }
