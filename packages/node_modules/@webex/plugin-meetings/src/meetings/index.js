...
export default class Meetings extends SparkPlugin {
    ...
    constructor(...args) {
      ...
      this.onReady();
      Metrics.initialSetup(this.meetingCollection, this.spark.version);
    }
    ...
    handleLocusEvent(data) {
      ...
      this.meetingCollection.getByKey(CORRELATION_ID, MeetingsUtil.checkForCorrelationId(this.spark.internal.device.url, data.locus)) ||
      ...
      console.log('LOCUS EVENT ', JSON.stringify(data));
      if (!meeting) {
        ...
        this.create(data.locus, _LOCUS_ID_).then((newMeeting) => {
          ...
          .finally(() => {
            ...
            Metrics.notificationReceived({meeting, data: {trigger: MetricsConfig.trigger.MERCURY_EVENT}});

            Metrics.remoteStarted({meeting, data: {trigger: MetricsConfig.trigger.MERCURY_EVENT}});
            Trigger.trigger(
              this,
              {
                file: 'meetings',
