...
export default class Meetings extends WebexPlugin {
    ...
    handleLocusMercury(envelope) {
      ...
      if (eventType && eventType !== LOCUSEVENT.MESSAGE_ROAP) {
        this.handleLocusEvent(data, 'handleLocusMercury');
      }
    }
    ...
    */
    ...
    async createMeeting(destination, type = null, source = null) {
      ...
      const handleLocusMercuryIsSource = (source === 'handleLocusMercury');
      ...
      try {
        ...
        if (!isMeetingActive && handleLocusMercuryIsSource && waitingTime > 0) {
          meeting.setTimeoutFetchMeetingInfoId = setTimeout(() => meeting.fetchMeetingInfo({}), waitingTime);
        }
        else {
