...
export default class Meetings extends SparkPlugin {
    ...
    handleLocusEvent(data) {
      ...
      this.meetingCollection.getByKey(SIP_URI, data.locus.self.callbackInfo && data.locus.self.callbackInfo.callbackAddress);
      ...
      if (!meeting) {
        ...
        console.log(`${this.name} MERCURY->APP: LOCUS OBJECT`, JSON.stringify(data.locus, null, '\t'));
