...
export const MEETING_CONTROLS_STATE_MACHINE = {
  TRANSITIONS: {
    TOGGLE: 'toggle'
  },
  STATES: {
    AUDIO_OFF_VIDEO_ON: 'AUDIO_OFF_VIDEO_ON',
    AUDIO_ON_VIDEO_ON: 'AUDIO_ON_VIDEO_ON',
    AUDIO_OFF_VIDEO_OFF: 'AUDIO_OFF_VIDEO_OFF',
    AUDIO_ON_VIDEO_OFF: 'AUDIO_ON_VIDEO_OFF'
  }
};
export const SDP = {
