...
export const DEFAULT_TRANSFORM_REGEX = {
  remoteVideo: {
    regex: new RegExp('^RTCRemoteInboundRtpVideoStream.*')
  },
  remoteAudio: {
    regex: new RegExp('^RTCRemoteInboundRtpAudioStream.*')
  },
  rtpOutVideo: {
...
export const DEFAULT_GET_STATS_FILTER = {
  types: ['track', 'transport', 'candidate-pair', 'outbound-rtp', 'outboundrtp', 'inbound-rtp', 'inboundrtp', 'remote-inbound-rtp']
};
export const DEFAULT_EVENT_VIDEO_SEND_KEYS = ['rtpOutVideo', 'rtcOutVideo', 'rtcTransVideo', 'remoteVideo'];
export const DEFAULT_EVENT_AUDIO_SEND_KEYS = ['rtpOutAudio', 'rtcOutAudio', 'rtcTransAudio', 'remoteAudio'];
export const DEFAULT_EVENT_VIDEO_RECEIVE_KEYS = ['rtpInVideo', 'rtcInVideo', 'rtcTransVideo', 'remoteVideo'];
export const DEFAULT_EVENT_AUDIO_RECEIVE_KEYS = ['rtpInAudio', 'rtcInAudio', 'rtcTransAudio', 'remoteAudio'];
