...
export const EVENT_TRIGGERS = {
  ...
  MEETING_ALERTED: 'meeting:alerted',
  MEETING_RINGING: 'meeting:ringing',
  MEMBERS_CREATED: 'members:created',
  MEETING_RECONNECTION_STARTING: 'meeting:reconnection_starting',
  MEETING_RECONNECTION_SUCCESS: 'meeting:reconnection_success',
  MEETING_RECONNECTION_FAILURE: 'meeting:reconnection_failure'
};
