...
PC.createOffer = (params) => {
  ...
  try {
    const pc = params.mediaPeerConnection || new window.RTCPeerConnection(bowser.firefox ? calls.rtcConfigurationFirefox : calls.rtcConfiguration);
    if (params.streams) {
