...
export default class ReconnectionManager {
  ...
  media(meeting) {
    ...
    return this.reconnectMedia(meeting)
      ...
      .catch((err) => {
        LoggerProxy.logger.warn(`ReconnectionManager:index#media --> Media could not reuse peer connection, failed with ${err}`);
        ...
        return meeting.reconnectMedia(true)
          .catch((error) => {
            LoggerProxy.logger.error(`ReconnectionManager:index#media --> Error reconnecting , error: ${error}`);
          });
      });
  }
