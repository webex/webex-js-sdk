...
<html>
  ...
  <body>
    ...
    <fieldset id="incomingsection" style="display:none">
      ...
      <button id="incoming-media">add media</button>
    </fieldset>
    <form id="credentials">
      <fieldset>
    ...
    <form id="dialer">
      <fieldset>
        ...
        <button id="getShare" title="getShare" disable type="button">getShare</button>
    ...
    <div>
      ...
      <video style="--width: 35%;width: var(--width);height: calc(var(--width) * 0.75);" id="remoteaudio" autoplay></video>
