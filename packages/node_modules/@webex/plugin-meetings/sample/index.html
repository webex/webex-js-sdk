  ...
  <body>
    ...
    <form id="in-meeting-actions">
      <fieldset>
        ...
        <button id="check-lock-anytime" title="check-lock-status" type="button">Check Lock Status</button>
      </fieldset>
    </form>
    ...
    <form id="dialer">
      <fieldset>
        ...
        <p>
          sip uri example: 126707703@alpha.ciscospark.com
          pstn number example: +18885550123
          convo id example: b7ab0370-911c-11e8-b40c-e117f23f1f95
          meeting link example: https://alpha.ciscospark.com/m/585b8b8f-5e73-4536-9147-f86cb70c8d81
        </p>
