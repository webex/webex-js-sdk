...
<html>
  ...
  <body>
    ...
    <fieldset id="incomingsection" style="display:none">
      ...
      <input id="answer" class="button" title="answer"  value="answer" />
      <input id="reject" class="button" title="reject"  value="reject" />
    </fieldset>
    <form id="credentials">
      <fieldset>
        <legend>Credentials</legend>
        <input id="access-token" name="accessToken" placeholder="Your access token" value="" type="text" />
        <input id="connect" class="button" title="connect" type="submit" value="connect" />
    ...
    <form id="disconnect">
      <fieldset>
        ...
        <input id="disconnecter" class="button" title="disconnect" type="submit" value="disconnect" />
      </fieldset>
    </form>


    <button id="device" class="button" name="device" title="Device" type="button">DEVICE</button>
    ...
    <form id="meetings">
      <fieldset>
        ...
        <button id="meetings-object" title="meetings object" class="button" type="button">Meetings</button>
      </fieldset>
    </form>
    ...
    <form id="dialer">
      <fieldset>
        ...
        <input id="invitee-number" name="invitee" value="" type="text" placeholder="+18005550123" />
        <input title="create" class="button" type="submit" value="create" />
      </br>
        <input id="invitee-convo" name="invitee-convo" value="" placeholder="9b84a810-f25e-11e8-ade8-059555e4f394" type="text" />
        <input title="create-convo" class="button" type="submit" value="create-convo" />
      </br>
        <input id="invitee" name="invitee" placeholder="arungane2@gmail.com" value="" type="text" /> 
        <input title="create" class="button" type="submit" value="create" />
      </br>
        <button id="join" class="button" title="join" type="button">join</button>
        <label>
        ...
        <button id="addMedia" class="button" title="addMedia" type="button">addMedia</button>
      </fieldset>
    </form>
    ...
    <form id="call-controls">
      <fieldset>
        ...
        <button id="usermedia" title="getMedia" type="button">getshare</button>
        ...
        <button id="getStatsRaw" title="start raw getStats" type="button">start raw getStats</button>
        <button id="getStatsFilter" title="start filter getStats" type="button">start filter getStats</button>
        <button id="getAggregation" title="get aggregation" type="button">get summary</button>
        <button id="getHistory" title="get history" type="button">get history</button>
        <button id="getInterval" title="get interval" type="button">get interval</button>
      </fieldset>
    </form>
        <h2>Extras</h2>
    ...
    <div>
      <video style="--width: 20%;width: var(--width);height: calc(var(--width) * 0.75);" id="localvideo" muted="true" autoplay></video>
      <video style="--width: 35%;width: var(--width);height: calc(var(--width) * 0.75);" id="remotevideo" autoplay></video>
      <video style="--width: 35%;width: var(--width);height: calc(var(--width) * 0.75);" id="sharevideo" autoplay></video>
      <video style="--width: 20%;width: var(--width);height: calc(var(--width) * 0.75);" id="localshare" autoplay></video>
    </div>
