  ...
  <body>
    ...
    <form id="call-controls">
      <fieldset>
        ...
        <button id="usermedia" title="getMedia" type="button">media</button>
        <button id="start" title="start" type="button">start</button>
...
<div>
<video style="height: 100px, width:100px" id='remotevideo' autoplay/>
<video style="height: 100px, width:100px" id='screenvideo' autoplay/>
</div>
