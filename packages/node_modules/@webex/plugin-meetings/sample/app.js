...
document.getElementById('join').addEventListener('click', () => {
  ...
  const hostPin = Number(document.getElementById('hostPin-join').value);
    ...
    .then((res) => {
      ...
      if (err.joinAsHostOrGuest) {
        ...
        document.getElementById('joinAsHost').addEventListener('click', () => {
          const hostPin = Number(document.getElementById('hostPin-join').value);
          const moderator = document.getElementById('moderator-join').checked;
          meeting.joinLobbyAsHost(hostPin, moderator)
            .then((res) => {
              console.log(res);
            })
            .catch((err) => {
        ...
        document.getElementById('joinAsGuest').addEventListener('click', () => {
          const moderator = document.getElementById('moderator-join').checked;
          meeting.joinLobbyAsGuest(moderator)
            .then((res) => {
              console.log(res);
            })
            .catch((err) => {
