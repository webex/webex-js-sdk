...
let activeMeeting, spark, meetings, meeting;
...
document.getElementById('dialer').addEventListener('submit', (event) => {
  ...
  event.preventDefault();
  return meetings.create(document.getElementById('invitee').value).then((m) => {
    meeting = m;
  });
  console.log(meeting.sip_uri);
});
