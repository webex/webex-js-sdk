...
document.getElementById('charting').addEventListener('click', () => {
  ...
  const analyzer = meeting.getAnalyzer(); // TODO: kitchen sink should be able to import a singleton???
  ...
  document.getElementById('addChartData').addEventListener('click', () => {
    ...
    const analysis = analyzer.analyze(thirtySecondsData, {properties: new Set(['bytesSent', 'packetsSent'])});
    const wholeData0 = [];
    const wholeData1 = [];
