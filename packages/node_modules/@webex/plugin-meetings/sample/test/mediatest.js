  ...
  describe('browser-call-with-screenshare', () => {
    describe('normal dialing', () => {
      ...
      it('bob answers the call', () => {
        ...
        browserBob.waitForVisible('#remotevideo', 20000);
        browserBob.waitForVisible('#stop-sending-audio', 20000);
        browserBob.click('#stop-sending-audio');
        browserAlice.waitForVisible('#stop-sending-audio', 20000);
        browserAlice.click('#stop-sending-audio');
        browserBob.pause(160000);
      });
