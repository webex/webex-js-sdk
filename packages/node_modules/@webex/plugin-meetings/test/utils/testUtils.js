...
// returns a promise that has resolve() and reject() methods
// allowing you to resolve/reject it at any time you want
...
const addMedia = (user) => {
  const mediaReadyPromises = {
    local: createControlledPromise(),
    remoteAudio: createControlledPromise(),
    remoteVideo: createControlledPromise(),
  };
  ...
  return user.meeting.getMediaStreams({
    ...
    .then(() => Promise.all(Object.values(mediaReadyPromises)))
    .then(() => {
