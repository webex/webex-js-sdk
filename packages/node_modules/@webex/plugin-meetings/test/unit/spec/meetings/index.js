      ...
      describe('#createMeeting', () => {
        ...
        describe('successful MeetingInfo.#fetchMeetingInfo', () => {
          ...
          it('creates the meeting from a successful meeting info fetch with random delay', async () => {
            ...
            const FAKE_TIME_TO_START = 0.1 * 60 * 1000;
            ...
            const fakeMeetingStartTimeString = fakeMeetingStartTimeDate.toISOString();
            ...
            const meeting = await webex.meetings.createMeeting(fakeDestination, 'test type', true);
            ...
            assert.calledWith(webex.meetings.meetingInfo.fetchMeetingInfo, fakeDestination, 'test type');
            assert.calledWith(MeetingsUtil.getMeetingAddedType, 'test type');
            assert.calledWith(TriggerProxy.trigger, sinon.match.instanceOf(Meetings), {
              file: 'meetings', function: 'createMeeting'
            }, 'meeting:added', {
