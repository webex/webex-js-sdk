...
import MeetingInfo from '../../../../src/meeting-info/index';
...
skipInBrowser(describe)('plugin-meetings', () => {
  ...
  describe('meeting-info request', () => {
    beforeEach(() => {
      ...
      meetingInfo = new MeetingInfo({}, {parent: webex});
    });
    describe('Private Detailed API', () => {
      describe('#fetchMeetingInfo', () => {
        ...
        it('Should call request with valid parameter', () => {
          meetingInfo.meetingInfoRequest.fetchMeetingInfo({
            type: _LOCUS_ID_,
