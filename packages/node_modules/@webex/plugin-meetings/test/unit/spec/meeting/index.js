    ...
    describe('Public Api Contract', () => {
      ...
      describe('#fetchMeetingInfo', () => {
        ...
        it('calls meetingInfoProvider with all the right parameters and parses the result', async () => {
          ...
          meeting.parseMeetingInfo = sinon.stub().returns(Promise.resolve());
        ...
        it('calls meetingInfoProvider with all the right parameters and parses the result when random delay is applied', async () => {
          ...
          meeting.setTimeoutFetchMeetingInfoId = FAKE_TIMEOUT_FETCHMEETINGINFO_ID;
          const clock = sinon.useFakeTimers();
          const clearTimeoutStub = sinon.spy(clock, 'clearTimeout');

          await meeting.fetchMeetingInfo({
            password: FAKE_PASSWORD, captchaCode: FAKE_CAPTCHA_CODE
          });

          assert.calledWith(clearTimeoutStub, FAKE_TIMEOUT_FETCHMEETINGINFO_ID);
          assert.isUndefined(meeting.setTimeoutFetchMeetingInfoId);
