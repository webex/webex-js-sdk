...
describe('plugin-meetings', () => {
  ...
  describe('meeting index', () => {
    describe('Public Api Contract', () => {
      ...
      describe('#mediaBusyEvent', () => {
        it('should have #mediaBusyEvent', () => {
          assert.exists(meeting.mediaBusyEvent);
        });
        beforeEach(() => {
          meeting.config.experimental = {enableMediaBusyEvent: true};
        });
        it('should trigger `MEDIA_SERVER_BUSY`', () => {
          meeting.mediaBusyEvent(true);

          assert.calledWith(
            TriggerProxy.trigger,
            sinon.match.instanceOf(Meeting),
            {file: 'meeting/index', function: 'mediaBusyEvent'},
            'media:serverBusy'
          );
        });

        it('should trigger `MEDIA_SERVER_AVALIABLE`', () => {
