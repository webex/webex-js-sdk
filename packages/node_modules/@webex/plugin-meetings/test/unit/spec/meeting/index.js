  ...
  describe('meeting index', () => {
    ...
    describe('Private Detailed API and Helpers', () => {
      ...
      describe('#parseMeetingInfo', () => {
        it('should parse meeting info, set values, and return null when locus meeting object is not available', () => {
          meeting.config.experimental = {enableMediaNegotiatedEvent: true};
          ...
          assert.equal(meeting.locusUrl, url1);
          assert.equal(meeting.sipUri, test1);
          assert.equal(meeting.meetingNumber, '12345');
          assert.equal(meeting.meetingJoinUrl, url2);
          assert.equal(meeting.owner, test2);
          assert.equal(meeting.permissionToken, 'abc');
        });
        it('should parse meeting info, set values, and return null when locus meeting object is available', () => {
          meeting.config.experimental = {enableMediaNegotiatedEvent: true};
        ...
        it('should parse meeting info, set values, and return null when destination is not an object', () => {
          meeting.config.experimental = {enableMediaNegotiatedEvent: true};
          const FAKE_DESTINATION = 'sipUrl';
          const FAKE_MEETING_INFO = {
            body: {
              conversationUrl: uuid1,
              locusUrl: url1,
          ...
          meeting.config.experimental.enableUnifiedMeetings = true;
          meeting.parseMeetingInfo(FAKE_MEETING_INFO, FAKE_DESTINATION);
          assert.equal(meeting.conversationUrl, uuid1);
          assert.equal(meeting.locusUrl, url1);
          assert.equal(meeting.sipUri, test1);
          assert.equal(meeting.meetingNumber, '12345');
