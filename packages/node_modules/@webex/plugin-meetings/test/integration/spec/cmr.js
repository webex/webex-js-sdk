...
CMR.reserve = (spark, claimed) => {
  ...
  if (claimed) {
    requestBody.body.requestMetaData.claimPmr = spark.internal.device.userId;
  }
  console.log('USER ID ', spark.internal.device.userId);

  return spark.request(requestBody)
    .then((response) => {
