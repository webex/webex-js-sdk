...
const addMedia = (user) => {
  ...
  return user.meeting.getMediaStreams({
    ...
    .then(([localStream, localShare]) => user.meeting.addMedia({
      ...
      assert.exists(mediaReadyEvent.local);
      assert.exists(mediaReadyEvent.remoteVideo);
      assert.exists(mediaReadyEvent.remoteAudio);
      assert.exists(user.meeting.mediaProperties.audioTrack);
      assert.exists(user.meeting.mediaProperties.videoTrack);
    });
};
