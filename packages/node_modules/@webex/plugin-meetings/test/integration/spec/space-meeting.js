...
describe('plugin-meetings-automation', () => {
  ...
  describe('plugin-meeting-space-meeting', () => {
    ...
    describe('Space meeting', () => {
      ...
      it('Alice starts a space meeting', () => alice.spark.internal.conversation.create({participants: [bob, chris]})
        .then((conversation) => {
      ...
      // });
      it('leaveSpaceMeeting', function endSpaceMeeting() {
        return Promise.all([
          ...
          .then(() => Promise.all([
            ...
            .then(() => {
              assert.equal(alice.meeting, null, 'alice meeting got removed');
              assert.equal(bob.meeting, null, 'bob meeting got removed');
              assert.equal(chris.meeting, null, 'chris meeting got removed');
            }));
      });
      // it('let guest user inside the meeting', () => guest.spark.meetings.create(space.id)
      //   .then((m) => m.join())
