...
describe('plugin-meetings-automation', () => {
  ...
  describe('plugin-meeting-space-meeting', () => {
    ...
    describe('Space meeting', () => {
      ...
      it('bob leave meeting', () => Promise.all([
      ...
      //   return testUtils.waitForStateChange(bob.meeting, 'LEFT');
      // }));

      it('chris leaves meeting', () => chris.meeting.leave()
        .then(() => {
          console.log('CHRIS DOES A LEAVE');
          assert.equal(alice.meeting, null, 'alice meeting got removed');
          assert.equal(bob.meeting, null, 'bob meeting got removed');
          assert.equal(chris.meeting, null, 'chris meeting got removed');
        }));
