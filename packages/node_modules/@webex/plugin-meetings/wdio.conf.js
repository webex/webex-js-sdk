...
exports.config = {
  ...
  //
  specs: [
    './packages/node_modules/@webex/plugin-meetings/sample/test/mediatest.js '
  ],
  //
  // ============
  // Capabilities
  ...
  staticServerFolders: [
    {mount: '/', path: './packages/node_modules/@webex/plugin-meetings/sample'},
    {mount: '/', path: '.'}
  ],
  ...
  onPrepare(config, capabilities) {
    const defs = [
      capabilities.browserAlice.desiredCapabilities,
      capabilities.browserBob.desiredCapabilities
    ];
...
if (CI) {
  ...
  exports.config.capabilities.browserAlice.seleniumVersion = '3.4.0';
  exports.config.capabilities.browserAlice.extendedDebugging = true;
  exports.config.capabilities.browserBob.seleniumVersion = '3.4.0';
  exports.config.capabilities.browserBob.extendedDebugging = true;
