  ...
  updateLastSeen(message) {
    ...
    return this.spark.internal.conversation.acknowledge(conversation, activity)
      .then((activity) => {
        ...
        return ({
          lastSeenId: buildHydraMessageId(activity.object.id),
          id: buildHydraMembershipId(activity.actor.entryUUID,
            activity.target.id),
          personId: buildHydraPersonId(activity.actor.entryUUID),
          personEmail: activity.actor.emailAddress || activity.actor.entryEmail,
          personDisplayName: activity.actor.displayName,
          personOrgId: buildHydraOrgId(activity.actor.orgId),
          roomId: buildHydraRoomId(activity.target.id),
          roomType: getHydraRoomType(activity.target.tags),
