...
const {createTestUser, createWhistlerTestUser, removeTestUser} = require('@webex/test-users');
 ...
 * @param {boolean} options.withWhistler use Whistler Service to generate test users
