...
const Calendar = WebexPlugin.extend({
  ...
  register() {
    ...
    if (this.registered) {
      this.logger.info('calendar->register#INFO, Meetings plugin already registered');
    ...
    return this.webex.internal.device.register()
      ...
      .then(() => {
        ...
        this.trigger('calendar:registered');
  ...
  unregister() {
    if (!this.registered) {
      this.logger.info('meetings->unregister#INFO, Meetings plugin already unregistered');
    ...
    return this.webex.internal.mercury.disconnect()
      ...
      .then(() => {
        this.trigger('calendar:unregistered');
  ...
  _handleUpdate(data) {
    ...
    this.trigger('calendar:update', CalendarCollection.get(id));
  },
  ...
  _handleCreate(data) {
    ...
    this.trigger('calendar:create', CalendarCollection.get(id));
  },
  ...
  _handleDelete(data) {
    ...
    this.trigger('calendar:delete', item);
  },
