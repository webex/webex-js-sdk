...
const Calendar = WebexPlugin.extend({
  ...
  _handleUpdate(data) {
    CalendarCollection.set(data.calendarMeetingExternal);
    this.trigger('calendar:meeting:update', data);
  },

  _handleCreate(data) {
    CalendarCollection.set(data.calendarMeetingExternal);
    this.trigger('calendar:meeting:create', data);
  },

  _handleDelete(data) {
    CalendarCollection.remove(data.calendarMeetingExternal.id);
    this.trigger('calendar:meeting:delete', data);
  },
