# @webex/internal-plugin-services

[![standard-readme compliant](https://img.shields.io/badge/readme%20style-standard-brightgreen.svg?style=flat-square)](https://github.com/RichardLitt/standard-readme)

> Plugin for the U2C service catalog
...
This plugin requires the environmental variable `U2C_SERVICE_URL` to be specified. See `.env.default` for more details.
...
webex.internal.services.WHATEVER
