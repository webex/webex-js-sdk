...
describe('plugin-services', () => {
  describe('Services', () => {
    ...
    describe('#status', () => {
      beforeEach(() => services.waitUntilReady());
    ...
    describe('#_serviceUrls', () => {
      beforeEach(() => services.updateServices('email', webexUser.email)
    ...
    describe('#services()', () => {
      ...
      it('calls _generateServicesList at least once', () => {
        sinon.spy(services, '_generateServicesList');

        services.services();

        assert.called(services._generateServicesList);
      });
    ...
    describe('#_getUrl()', () => {
      ...
      beforeEach('load test url', () => services.waitUntilReady()
        .then(() => {
          testUrlTemplate = {
    ...
    describe('#_loadServiceUrls()', () => {
      ...
      beforeEach('init test url', () => services.waitUntilReady()
        .then(() => {
          testUrlTemplate = {
            defaultUrl: 'https://www.example.com/api/v1',
            hosts: [],
