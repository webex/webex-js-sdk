...
describe(`ciscospark`, function() {
  ...
  describe(`CiscoSpark`, () => {
    ...
    describe(`#rooms`, () => {
      ...
      describe(`#create()`, () => {
        // COLLAB-1104 create dates don't match; Mike is working on a fix
        ...
        describe(`when the user leaves the team's general room`, () => {
          ...
          it(`no longer returns the team's rooms`, () => spark.teams.create({
            ...
            .then((teamRooms) => {
              ...
              return spark.teamMemberships.list({teamId: generalRoom.teamId, personId: user.id});
            })
            .then((memberships) => {
              return spark.teamMemberships.remove(memberships.items[0]);
            })
            .then(() => {
