    ...
    <section>
      ...
      <form id="current-meeting">
        <fieldset>
          ...
          <input id="dialout-destination" name="dialout-destination" placeholder="phone number" value="" type="text" />
          <button id="dialout-destination-action" type="button" onclick="dialoutPstn()">webex.meetings.create()</button>
