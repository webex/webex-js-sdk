    ...
    <section>
      ...
      <form id="effects">
        <fieldset>
          ...
          <button id="effect" type="button" disabled>setBlur()</button>
          <button id="uneffect" type="button" hidden>unBlur()</button>
          <button id="mask" type="button" disabled>setMask()</button>
          <button id="unmask" type="button" hidden>unMask()</button>
        </fieldset>
      </form>
    </section>
      ...
      <form id="streams">
        <div class="flex">
          <fieldset>
            ...
            <video id="local-video" muted="true" width="480" height="320" autoplay playsinline></video>
            <canvas hidden id="local-canvas"></canvas>
          </fieldset>
