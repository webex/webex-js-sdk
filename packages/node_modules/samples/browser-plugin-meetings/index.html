      ...
      <form id="meetings-create">
        <fieldset>
          ...
          <select name="type" id="meeting-type">
            ...
            <option value="MEETING_ID">MEETING_ID</option>
            <option value="CONVERSATION_URL">CONVERSATION_URL</option>
            <option value="SIP_URL">SIP_URL</option>
            <option value="_MEETING_LINK_">MEETING_LINK</option>
            <option value="_MEETING_UUID_">MEETING_UUID</option>
            <option value="PERSONAL_ROOM">PERSONAL_ROOM</option>
          </select>
