...
<html lang="en">
  ...
  <body>
      ...
      <form id="source-devices-controls">
        ...
        <fieldset>
          ...
          <div>
            ...
            <button id="detect-audio-silence" type="button" onclick="detectAudioSilence()">meeting.media.detectAudioSilence()</button>
          ...
          <div>
            ...
            <button id="detect-video-silence" type="button" onclick="detectVideoSilence()">meeting.media.detectVideoSilence()</button>
    ...
    <section>
      ...
      <form id="streams">
        <div class="flex">
          <fieldset class="local-video">
            <legend>Local Video</legend>
            <video id="local-video" muted="true" autoplay playsinline></video>
            <p id="audio-silence-status">AUDIO SILENCE: ----</p>
            <p id="video-silence-status">VIDEO SILENCE: ----</p>
            <button id="check-silence-status" type="button" onclick="checkSilenceStatus()">&#8635;</button>
          </fieldset>
