...
<html lang="en">
 ...
 <section>
  <fieldset>
    ...
    <input id="aspect-ratio" name="aspectRatio" placeholder="aspectratio" value="1.77" type="text" />
    <input id="height" name="height" placeholder="height" value="480" type="text" />
    <input id="width" name="width" placeholder="width" value="720" type="text" />
    <video id="local-video-exp" muted="true" autoplay playsinline></video>
    <button id="rerun-camera" name="camera" placeholder="reruncamera"  type="button" onclick="reInitiateCamera()">RE-run</button>
  </fieldset>
   </section>
