  ...
  return meeting.getMediaStreams(mediaSettings, audioVideoInputDevices)
    ...
    .then(([localStream]) => {
      if (localStream && mediaSettings.sendVideo) {
        ...
        // Safari fix, see function definition.
        playVideoIfPaused(meetingStreamsLocalVideo);
      }
  ...
  meeting.on('media:ready', (media) => {
    ...
    switch (media.type) {
      case 'remoteVideo':
        ...
        playVideoIfPaused(meetingStreamsRemotelVideo);
        break;
      case 'remoteAudio':
      ...
      case 'remoteShare':
        ...
        playVideoIfPaused(meetingStreamsRemoteShare);
        break;
      case 'localShare':
        meetingStreamsLocalShare.srcObject = media.stream;
        playVideoIfPaused(meetingStreamsLocalShare);
        break;
    }
  });
}
