...
const reRunCamera = document.querySelector('#rerun-camera');
const localVideoExp = document.querySelector('#local-video-exp');

function reInitiateCamera() {
  webex.meetings.media.getUserMedia({sendVideo: true, sendAudio: false, sendShare: false},
    {
      video: {
        facingMode: 'user',
        width: width.value,
    ...
    .then(([localStream]) => {
      localVideoExp.srcObject = localStream;
    });
}
