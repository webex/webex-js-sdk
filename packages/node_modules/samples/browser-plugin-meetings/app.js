...
function initWebex() {
  ...
  webex2 = window.webex2 = Webex.init({
    config: {
      logger: {
        level: 'debug'
      },
    ...
    credentials: {
      access_token: 'MDE2ODdlZGItZWI2ZC00Y2YzLWI1NzktNmEyZTM5Nzg1ODBiYmNjZGU3NzgtMWFl_PF84_1eb65fdf-9643-417f-9974-ad72cae0e10f'
    }
  });

  webex2.once('ready', () => {
    console.log('Authentication#initWebex() :: Webex Ready2');
  });

  webex2.meetings.register();
}
...
const dialoutDestinationElm = document.querySelector('#dialout-destination-action');
...
function dialoutPstn() {
  const meeting = getCurrentMeeting();

  meeting.dialoutMeeting({dialout: {invitee: dialoutDestinationElm.value}});
}
