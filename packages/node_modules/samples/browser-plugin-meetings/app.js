...
const createMeetingType = document.querySelector('#meeting-type');
...
function createMeeting() {
  const meetingType = createMeetingType.value;

  webex.meetings.create(createMeetingDestinationElm.value, meetingType)
    .then((meeting) => {
      generalStartReceivingTranscription.disabled = false; // eslint-disable-line no-use-before-define
