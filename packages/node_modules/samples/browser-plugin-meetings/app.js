...
document.getElementById('updateAudio').addEventListener('click', () => {
  ...
  // TODO: change this to check previous media values
  if (media.sendAudio) {
...
document.getElementById('check-lock-anytime').addEventListener('click', () => {
  if (meeting) {
...
document.getElementById('charting').addEventListener('click', () => {
  ...
  const analyzer = spark.meetings.getAnalyzer();
