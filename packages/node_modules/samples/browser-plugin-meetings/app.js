...
const registrationBanner = document.querySelector('#registrationBanner');
...
function register() {
  ...
  webex.meetings.register()
    ...
    .finally(() => {
      registrationBanner.classList.remove('md-alert-banner--warning');
      registrationBanner.classList.add('md-alert-banner--info');
...
function unregister() {
  ...
  webex.meetings.unregister()
    ...
    .finally(() => {
      registrationBanner.classList.remove('md-alert-banner--info');
      registrationBanner.classList.add('md-alert-banner--warning');
