describe('samples/browser-single-party-call', () => {
  ...
  describe('saved values', () => {
    it('stores form values across page loads', () => {
      ...
      browser.select('browserSpock').assertTitle('Sample: Single Party Calling');
      ...
      browser.select('browserSpock').assertValue('#access-token', 1);
      browser.select('browserSpock').assertValue('#invitee', 2);
    });
  });
});
