      ...
      <div class="columns">
        <div class="column col-12">
          ...
          <div id=initial-login>
            <h2>Monitor who has read messages in a user's Webex spaces</h2>

            <p>Login into your Webex Account to get your <a target="_blank" href="https://developer.webex.com/docs/api/getting-started"> Personal Access Token</a>.</p>
            <form class="form-group" id="credentials">
              <fieldset>
                ...
                <input
                  ...
                  type="text" />
                <button class="btn" id="login" title="login" type="submit">Login</button>
                <button class="btn" id="read" title="read" type="click">Read</button>
              </fieldset>
              <p class="label label-warning" id="connection-status">not connected
          ...
          <div id=space-status style="display:none">
            ...
            <center>
              ...
              <div id='initializing-membership'>Open a space with unread messages in Webex to generate a read receipt</div>
              ...
              <div id='pre-message'>Send a message in a Webex client to generate message activity</div>
