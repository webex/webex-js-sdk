...
const webex = window.webex = Webex.init({
  config: {
    ...
    credentials: {
      client_id: 'C7e95c1512b00a0d1be28eddf3ca9308e4161b0f807607d05ff34c69f5f91f4ca',
      redirectURL,
...
webex.once('ready', () => {
  // Handle a button push on the "Login" button
  ...
  if (webex.canAuthorize) {
    document.getElementById('access-token').value = this.webex.credentials.supertoken.access_token;
  }
});
