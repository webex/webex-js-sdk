        ...
        <form id="typeCredentials">
          <fieldset>
            <legend>Pick Method of Getting Access Token</legend>
              <div>
                <input type="radio" id="paste" name="drone" onclick="handleRadio()" value="paste"checked>
                <label for="huey">Paste Access Token</label>
              </div>
              <div>
                <input type="radio" id="oauth" name="drone" onclick="handleRadio()" value="oauth" checked>
        ...
        <form id="registeration">
          <fieldset>
            <legend>Register</legend>
              <button id="register" title="register" type="button">register</button>
            </div>
