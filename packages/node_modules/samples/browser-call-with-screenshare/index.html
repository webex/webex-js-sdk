        ...
        <table id="video-streams">
          ...
          <tbody>
            <tr>
              <td>Local</td>
              <td>
                <video style="max-width: 250px; max-height: 250px;" id="self-view" muted autoplay></video>
              </td>
              <td>
                <video style="max-width: 250px; max-height: 250px;" id="self-screen" muted autoplay></video>
              </td>
            </tr>
            <tr>
              <td>Remote</td>
              <td>
                <video style="max-width: 250px; max-height: 250px;" id="remote-view-video" autoplay></video>
                <audio id="remote-view-audio" autoplay></audio>
              </td>
              <td>
                <video style="max-width: 250px; max-height: 250px;" id="remote-screen" muted autoplay></video>
              </td>
            </tr>
          </tbody>
        </table>
