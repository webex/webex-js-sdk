...
function bindCallEvents(call) {
  ...
  call.on('all', (e) => {
    document.getElementById('event-list').innerHTML += `${e}\r\n`;
  });
  ...
  call.on('localScreenShare:change', () => {
    if (call.localScreenShare && call.localScreenShare.getVideoTracks()[0].enabled) {
      document.getElementById('self-screen').srcObject = call.localScreenShare;
      document.getElementById('screenshare-tracks').innerHTML = call.localScreenShare.getVideoTracks().length;
    }
    else {
