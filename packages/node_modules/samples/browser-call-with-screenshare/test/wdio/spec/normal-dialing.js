...
describe('samples/browser-call-with-screenshare', () => {
  describe('normal dialing', () => {
    ...
    it('starts screensharing', () => {
      ...
      browser.waitUntil(() => browserSpock.getText('#screenshare-tracks') === '1',
        100000, 'Timed-out waiting for screenshare track to be added');
    });

    it('stops screensharing', () => {
      browserSpock.click('button[title="stop screen share"]');
      browser.waitUntil(() => browserSpock.getText('#screenshare-tracks') === '0',
        100000, 'Timed-out waiting for screenshare track to be removed');
    });

    it('starts application sharing', () => {
      browserSpock.click('[title="share application"]');
