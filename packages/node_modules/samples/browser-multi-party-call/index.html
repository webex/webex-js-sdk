      ...
      <form id="credentials">
        <fieldset>
          <legend>Credentials</legend>
            <div style="width: 35vw; display: flex; flex-direction: row; justify-content: space-between">
              <h3>Authentication Status: </h3>
              <h3 style="color:red; margin-right: 5px;" id="authentication-status">Not Authenticated</h3>
