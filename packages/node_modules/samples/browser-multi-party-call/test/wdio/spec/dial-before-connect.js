...
describe('Multi Party Calling - Dial before connecting', () => {
  describe('Dial before connecting (Token)', () => {
    ...
    it('register device for mccoy after the call was placed and join call', () => {
  ...
  describe('Dial before connecting (OAuth)', () => {
    let mccoy, roomId, spock;
    ...
    it('redirect to sample app for spock and verify auth', () => {
      browserFirefox.waitUntil(
        () => browserFirefox.getTitle() === 'Sample: Multi Party Calling',
        {
          timeout: 10000,
    ...
    it('redirects to sample app for mccoy and verify auth', () => {
      browserChrome.waitUntil(
        () => browserChrome.getTitle() === 'Sample: Multi Party Calling',
        {
          timeout: 10000,
