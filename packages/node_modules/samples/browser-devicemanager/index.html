...
<body>
  <div style="width:100%;">
    ...
    <div style="float:inherit;">
      ...
      <p>This is the start of the "kitchen sink" demo app for plugin-devicemanager.</p>
      ...
      <form id="deviceControls" name="deviceControls">
        <fieldset>
          ...
          <div>
            <div id='listAllDevicesDiv' style="display:block; float:left">
              <button id="listAllDevices" name="listAllDevices" title="List of all devices" type="button">listAllDevices</button>
            </div>
