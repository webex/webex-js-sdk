...
document.getElementById('deviceControls').listAllDevices.addEventListener('click', () => {
  if (spark.devicemanager) {
    notify('Listing devices...');
    return spark.devicemanager.listAllDevices()
      .then((devices) => {
...
document.getElementById('requestPairing').addEventListener('click', () => {
  if (spark.devicemanager) {
    ...
    return spark.devicemanager.pair({pin})
      ...
      .then(() => spark.devicemanager.listAllDevices())
      .then((devices) => {
        populateDeviceDropdown(devices);
        notify('');
        toggleDisplay('requestPinDiv', true);
...
document.getElementById('bindSpace').addEventListener('click', () => {
  if (spark.devicemanager) {
    ...
    return spark.devicemanager.bindSpace(convoId)
      .then(() => {
  ...
  response.forEach((device) => {
    devices += `
      <li style='list-style-type: none'>
        ...
        <label>${device.name || device.description}</label>
      </li>`;
  });
