...
function generateAddedMembers(id, name, statuObj) {
  ...
  const buttons = [
    createButton('Admit', 'participant-a-admit', admitMember, id),
    createButton('Remove', 'participant-a-remove', removeMember, id),
    createButton('Mute', 'participant-a-mute', muteMember, id),
    createButton('Transfer Ownership To',
      'participant-a-transfer-ownership',
      transferHostToMember,
      id)
  ];
