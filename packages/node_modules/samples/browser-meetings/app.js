...
document.getElementById('getStatsFilter').addEventListener('click', () => {
  if (meeting) {
    ...
    meeting.getStats().getMedia().getEvents().on('stats:update', (stats) => {
      console.log(stats);
    });
  }
});
...
document.getElementById('getAggregation').addEventListener('click', () => {
  if (meeting) {
    console.log(meeting.getStats().getMedia().getAggregator().getSummary());
  }
});

document.getElementById('getHistory').addEventListener('click', () => {
  if (meeting) {
    console.log(meeting.getStats().getMedia().getHistory().getHistory());
  }
});

document.getElementById('getInterval').addEventListener('click', () => {
  if (meeting) {
    console.log(meeting.getStats().getMedia().getInterval().getInterval());
  }
});
...
document.getElementById('PMR').addEventListener('submit', (event) => {
  event.preventDefault();
  return spark.meetings.personalMeetingRoom.getPersonalMeetingRoom().then((pmr) => {
