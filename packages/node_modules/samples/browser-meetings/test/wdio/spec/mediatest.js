  ...
  describe('browser-plugin-meetings', () => {
    describe('normal dialing', () => {
      ...
      it('connects mccoys\'s browser', () => {
        ...
        browserChrome.click('#access-token-save');

        // registeration
        browserChrome.pause(10000);
        browserChrome.click('#registration-register');
        ...
        browserChrome.waitUntil(() => {
          ...
          if (browserChrome.getText('#access-token-status') !== 'Saved') {
            return false;
          }
      ...
      it('connects spock\'s browser', () => {
        ...
        browserFirefox.click('#access-token-save');
        ...
        browserFirefox.waitUntil(() => {
          // Test runs too quickly sometimes and tries to click before call is fully established
          if (browserFirefox.getText('#access-token-status') !== 'Saved') {
            return false;
          }
      ...
      it('places call from spock to mccoy', () => {
        browserFirefox.setValue('#create-meeting-destination', mccoy.emailAddress);
        browserFirefox.click('#create-meeting-action');
        browserFirefox.pause(5000);
        browserFirefox.click('#meetings-list button');
        browserFirefox.pause(5000);
      });
