        ...
        <fieldset>
            ...
            <div>
              ...
              <div>
                ...
                <label>
                  <input type="checkbox" name="ts-media-direction" value="sendShare">sendShare
                </label>
              </div>
            </div>
        </fieldset>
      ...
      <form id="toggling-sources-controls">
        <fieldset>
          ...
          <div>
            ...
            <button id="ts-start-screenshare" type="button" onclick="startScreenShare()">meeting.updateShare()</button>
      ...
      <form id="participants">
        <fieldset>
          ...
          <div>
            ...
            <button id="add-participant" onclick="inviteMember(this)" type="button">Add</button>
          </div>
          <p>New participants will be added below</p>
          <div class="particpantList">
            <button data-id="participant-a-admit" onclick="admitMember(this)" type="button" value="[[PARTICIPANT ID]]">Admit</button>
            <button data-id="participant-a-remove" type="button" onclick="removeMember(this)" value="[[PARTICIPANT ID]]">Remove</button>
            <button data-id="participant-a-mute" type="button" onclick="muteMember(this)" value="[[PARTICIPANT ID]]">Mute</button>
            <button data-id="participant-a-transfer-ownership" type="button" onclick="transferHostToMember(this)" value="[[PARTICIPANT ID]]">Transfer Ownership To</button>
            <label data-id="participant-a-id">[[PARTICIPANT ID]]</label>
            <label data-id="participant-a-status">[[PARTICIPANT STATUS]]</label>
            <label data-id="participant-a-name">[[PARTICIPANT NAME]]</label>
          </div>
          <br />
          <button id="updated-participants" onclick="viewParticipants()" type="button">View current participants</button>
          <div id="particpant-listing"></div>
        </fieldset>
      </form>
    </section>
