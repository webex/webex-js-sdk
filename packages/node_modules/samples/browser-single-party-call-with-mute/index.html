  ...
  <body>
    ...
    <form id="call-controls">
      <fieldset>
        ...
        <button id="toggle-receiving-video" title="toggle receiving video" type="button">toggle receiving video</button>
        <button id="toggle-receiving-audio" title="toggle receiving audio" type="button">toggle receiving audio</button>
        <button id="toggle-sending-video" title="toggle sending video" type="button">toggle sending video</button>
        <button id="toggle-sending-audio" title="toggle sending audio" type="button">toggle sending audio</button>
      </fieldset>
    </form>
    ...
    <div style="align-items: flex-start; display: flex; max-width: 100%">
      <div style="flex: 1 1 auto">
        ...
        <div style="display: flex">
          <div>
            <p>Incoming Audio Stats</p>
            <pre id="incoming-audio-stats"></pre>
          </div>
          <div>
            <p>Incoming Video Stats</p>
            <pre id="incoming-video-stats"></pre>
          </div>
        </div>
        <div style="display: flex">
          <div>
            <p>Raw Stats</p>
            <pre id="raw-video-stats"></pre>
          </div>
        </div>
      </div>
