<!DOCTYPE html>
<html>
  <title>Sample: in Browser Authentication</title>
  <body>
    ...
    <form id="authorization">
      <input id="authBtn" title="authenticate" type="submit" value="authenticate">
      <label for="authenticate"> &lt-- click here to <span id="buttonTip">authenticate</span></label>
    </form>
