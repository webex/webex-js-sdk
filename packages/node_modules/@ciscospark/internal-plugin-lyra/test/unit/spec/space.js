...
describe('plugin-lyra', () => {
  ...
  describe('space', () => {
    ...
    describe('#join()', () => {
      ...
      it('allows another uri', () => spark.internal.lyra.space.join(lyraSpace, {uri: 'https://customUrl'})
        .then(() => assert.calledWith(spark.request, sinon.match({
          method: 'PUT',
          uri: 'https://customUrl',
          body: {
      ...
      it('passes on extra data field', () => spark.internal.lyra.space.join(lyraSpace, {
        passType: 'TEST',
        data: {proof: 'abc'}
      })
        .then(() => assert.calledWith(spark.request, sinon.match({
