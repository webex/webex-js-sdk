 ...
 * @memberof Lyra
 */
export default class Space extends StatelessSparkPlugin {
  namespace = 'Lyra';
   ...
   * @returns {Promise<LyraBindings>} bindings response body
   */
  bindConversation(space = {}, conversation = {}) {
    const spaceId = space.id || space.identity && space.identity.id;
   ...
   * @returns {Promise<LyraBindings>} bindings response body
   */
  unbindConversation(space = {}, conversation) {
    const spaceId = space.id || space.identity && space.identity.id;
    ...
    return this.spark.internal.encryption.kms.prepareRequest(parameters.kmsMessage)
      .then((req) => {
