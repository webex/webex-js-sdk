...
export default class Team extends StatelessSparkPlugin {
  ...
  createConversation(team, params, options) {
    ...
    return this._inferTeamUrl(team)
      ...
      .then((generalConversation) => Promise.all(params.participants.map((participant) => this.spark.internal.user.asUUID(participant, {create: true})))
        .then((participants) => {
          participants.unshift(this.spark.internal.device.userId);
          params.participants = uniq(participants);
        })
