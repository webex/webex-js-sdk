  ...
  setBundledFeatures(featureList) {
    ...
    return this.request({
      ...
      .then((res) => {
        ...
        this.spark.device.features.user.add(partitionedToggles[0], {merge: true});
        this.spark.device.features.developer.add(partitionedToggles[1], {merge: true});
        return this.spark.device.features;
      });
  },
