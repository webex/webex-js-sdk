...
import Feature from '@ciscospark/plugin-feature';
  ...
  describe(`Feature`, () => {
    ...
    describe(`#getFeature()`, () => {
      ...
      it(`returns the full feature object`, () => {
        ...
        return assert.becomes(spark.internal.feature.getFeature(keyType, key, {full: true}), feature);
      });
      ...
      it(`returns the feature value`, () => {
        ...
        spark.internal.device.features[keyType].add(feature);
        return assert.becomes(spark.internal.feature.getFeature(keyType, key), feature.value);
      });
    });
