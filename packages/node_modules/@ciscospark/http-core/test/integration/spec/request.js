...
describe('http-core', function () {
  ...
  describe('request()', () => {
    ...
    describe('POST', () => {
      before('determine whether to skip these flaky tests', () => {
        const skipFlaky = process.env.SKIP_FLAKY_TESTS;
        if (skipFlaky && skipFlaky !== 'false' && !!skipFlaky) {
          this.parent.pending = true; // temporary until a future mocha release
          this.skip();
        }
      });

      it('submits files as multipart form data', () => {
