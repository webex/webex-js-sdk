  ...
  describe(`People`, () => {
    ...
    describe(`#list()`, () => {
      ...
      it(`defaults to false showAllTypes`, () => {
        return spock.spark.people.list([mccoy.id, spock.id, bones.id])
          .then(
            assert.isFalse(spock.spark.people.batcher.showAllTypes)
          );
      });

      it(`sets showAllTypes to true`, () => {
        return spock.spark.people.list([mccoy.id, spock.id, bones.id], true)
          .then(
            assert.isTrue(spock.spark.people.batcher.showAllTypes)
          );
      });
