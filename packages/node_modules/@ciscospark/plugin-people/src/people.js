...
const People = SparkPlugin.extend({
   ...
   *       personEmail: 'alice@wx2.example.com',
   *       roomId: room.id
   *     });
   *   })
   ...
   *       return email === 'alice@wx2.example.com';
   *     }).length, 1);
   ...
   *   .then(function() {
   *     return ciscospark.memberships.create({
   *       personEmail: 'bob@wx2.example.com',
   *       roomId: room.id
   *     });
   *   })
   *   .then(function() {
   *     return ciscospark.people.list({email: 'alice@wx2.example.com'});
   *   })
