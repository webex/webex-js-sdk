...
// as of v1.5, localforage uses IndexedDB for safari v10.1+
// see https://github.com/localForage/localForage/blob/master/CHANGELOG.md#15
// we want to force it to use WebSQL until we migrate to use IndexedDB
import localForageCompatibility from 'localforage-compatibility-1-4';

localForageCompatibility.config().then(() => localforage.setDriver([localforage.WEBSQL]));
