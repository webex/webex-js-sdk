  ...
  describe(`Device`, () => {
    ...
    describe(`when a call is in progress`, () => {
      ...
      it(`allows muting`, (done) => {
        ...
        return spock.spark.lyra.device.mute(lyraMachine.space);
      });
      ...
      it(`allows unmuting`, (done) => {
        ...
        return spock.spark.lyra.device.unmute(lyraMachine.space);
      });
      ...
      it(`allows increasing volume`, (done) => {
        ...
        return spock.spark.lyra.device.increaseVolume(lyraMachine.space);
      });
      ...
      it(`allows decreasing volume`, (done) => {
        ...
        return spock.spark.lyra.device.decreaseVolume(lyraMachine.space);
      });
      ...
      it(`allows setting volumne`, (done) => {
        ...
        return spock.spark.lyra.device.setVolume(lyraMachine.space, 2);
      });
    });
  });
});
