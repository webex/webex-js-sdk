...
describe(`plugin-lyra`, () => {
  ...
  describe(`device`, () => {
    ...
    describe(`#putAudioState`, () => {
      it(`requires audioState.deviceUrl`, () => assert.isRejected(spark.lyra.device.putAudioState(lyraSpace), /audioState.deviceUrl is required/));
    });

    describe(`#setVolume`, () => {
      it(`defaults to level 0`, () => spark.lyra.device.setVolume(lyraSpace)
          .then(() => {
