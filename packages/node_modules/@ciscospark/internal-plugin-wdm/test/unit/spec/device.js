  ...
  describe(`Device`, () => {
    ...
    describe(`#useServiceCatalogUrl`, () => {
      it(`replaces current url with url from the service catalog`, () => {
        return device.useServiceCatalogUrl(`https://conv-a.wbx2.com/conversation/v1`)
    ...
    describe(`#markUrlFailedAndGetNew()`, () => {
      ...
      it(`returns service url for the next available host`, () => {
        return device.markUrlFailedAndGetNew(`https://mercury-connection.a6.ciscospark.com/v1`)
