...
describe('plugin-user', () => {
  ...
  describe('User-EU', () => {
    ...
    beforeEach(() => {
      ...
      spark.config.credentials.federation = true;
    });
    ...
    describe('#setPassword()', () => {
      it('requires a `password` and `email` for Federation user', () => assert.isRejected(userService.setPassword({password: 'foo'}), /email is required with federation option/));
    });
  });
});
