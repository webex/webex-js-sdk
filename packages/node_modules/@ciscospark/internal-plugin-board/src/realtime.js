  ...
  connectToSharedMercury(channel) {
    return this.spark.internal.board.registerToShareMercury(channel)
      .then((res) => {
        ...
        this.spark.internal.mercury.off(`online`, this.refreshMercurySocketReference, this);
        this.spark.internal.mercury.on(`online`, this.refreshMercurySocketReference, this);

        // make sure there's only one handler
        this.spark.internal.mercury.off(`event:board.activity`, this.handleBoardActivityMessages, this);
        this.spark.internal.mercury.on(`event:board.activity`, this.handleBoardActivityMessages, this);
        return res;
      });
  },
