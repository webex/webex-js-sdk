  ...
  describe('realtime', () => {
    ...
    describe('when trying to share mercury connection', () => {
      ...
      describe('#connectToSharedMercury', () => {
        it('registers and gets board binding', () => spark.internal.board.realtime.connectToSharedMercury()
          .then((res) => {
      ...
      describe('#disconnectFromSharedMercury', () => {
        it('requests to remove board bindings', () => spark.internal.board.realtime.connectToSharedMercury()
          .then(() => {
            assert.isTrue(spark.internal.board.realtime.isSharingMercury);
