...
describe(`plugin-board`, () => {
  describe(`realtime - sharing mercury`, () => {
    ...
    beforeEach(`connect to mercury channel`, () => Promise.all(participants.map((participant) => {
      return participant.spark.internal.mercury.connect();
    })));

    afterEach(`disconnect mercury`, () => Promise.all(participants.map((participant) => {
    ...
    describe(`#publish()`, () => {
      describe(`string payload`, () => {
        ...
        after(() => Promise.all(participants.map((participant) => {
    ...
    describe(`multiple boards sharing a connection`, () => {
      ...
      afterEach(() => Promise.all(participants.map((participant) => {
        return promiseSeries([
