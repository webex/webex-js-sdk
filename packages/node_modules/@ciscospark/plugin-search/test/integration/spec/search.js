...
describe(`plugin-search`, () => {
  ...
  describe(`#search`, () => {
    ...
    before(`create a room for spock`, () => spockConversation || spock.spark.conversation.create({
    ...
    before(`create a room for mccoy`, () => mccoyConversation || mccoy.spark.conversation.create({
