...
describe(`plugin-search`, () => {
  describe(`#people`, () => {
    ...
    it(`searches for users with a specific string`, () => {
      return spark.internal.search.people({query: `abc`})
        .then((users) => {
    ...
    it(`retrieves a specific user`, () => {
      return spark.internal.search.people({query: mccoy.email})
        .then((users) => {
    ...
    it(`retrieves a bot`, () => {
      return spark.internal.search.people({query: bot.email, includeRobots: true})
        .then((bots) => {
    ...
    it(`doesn't retrieve a bot because of parameter`, () => {
      return spark.internal.search.people({query: bot.email, includeRobots: false})
        .then((bots) => {
  ...
  describe(`#search`, () => {
    ...
    before(() => spockConversation || spock.spark.internal.conversation.create({
    ...
    before(() => mccoyConversation || mccoy.spark.internal.conversation.create({
