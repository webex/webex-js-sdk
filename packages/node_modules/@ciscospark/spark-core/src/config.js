...
export default {
  ...
  credentials: {
     ...
     * @type {string}
     */
    authorizationString: process.env.AUTHORIZATION_STRING,
    /**
     * Authorization URL which prompts for user's password
     * @type {string}
     */
    authorizationUrl: process.env.AUTHORIZATION_URL || `${IDBROKER_BASE_URL}/idb/oauth2/v1/authorize`,
    /**
