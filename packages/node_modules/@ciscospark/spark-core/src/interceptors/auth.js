...
export default class AuthInterceptor extends Interceptor {
  ...
  requiresCredentials(options) {
    ...
    if (options.uri) {
      if (feature && feature.value && options.uri.includes(this.spark.config.device.preDiscoveryServices.hydra)) {
        return Promise.resolve(true);
      }
      if (options.uri.includes(this.spark.config.device.preDiscoveryServices.hydraServiceUrl)) {
        return Promise.resolve(true);
      }
    }
