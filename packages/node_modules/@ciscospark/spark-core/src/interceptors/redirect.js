...
export default class RedirectInterceptor extends Interceptor {
  ...
  onResponse(options, response) {
    ...
    else if (response.headers && response.body && response.body.errorCode === this.spark.config.LOCUS_REDIRECT_ERROR && response.body.location && response.options && response.options.qs && response.options.qs.alternateRedirect) {
      options = clone(options);
