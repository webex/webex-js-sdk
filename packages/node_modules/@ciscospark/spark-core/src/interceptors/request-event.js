...
export default class RequestEventInterceptor extends Interceptor {
  ...
  onRequest(options) {
    ...
    try {
      ...
      logger.info(`RequestEventInterceptor.onRequest failed for options:`, options);
    }
  ...
  onRequestError(options, reason) {
    ...
    try {
      ...
      logger.info(`RequestEventInterceptor.onRequestError failed for options:`, options, ` reason=`, reason);
    }
  ...
  onResponse(options, response) {
    ...
    try {
      ...
      logger.info(`RequestEventInterceptor.onResponse failed for options:`, options, ` response=`, response);
    }
  ...
  onResponseError(options, reason) {
    ...
    try {
      ...
      logger.info(`RequestEventInterceptor.onResponseError failed for options:`, options, ` reason=`, reason);
    }
    return Promise.reject(reason);
  }
