    ...
    describe(`AuthInterceptor`, () => {
      ...
      describe(`#onResponseError`, () => {
        describe(`when the server responds with 401`, () => {
          it(`refreshes the access token and replays the request`, () => {
            ...
            return assert.isFulfilled(interceptor.onResponseError(err.options, err))
              .then(() => {
                assert.called(spark.config.credentials.refreshCallback);
