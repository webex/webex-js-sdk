  ...
  describe('Interceptors', () => {
    describe('RateLimitInterceptor', () => {
      ...
      describe('#getApiName', () => {
        ...
        it('returns idbroker API name if there is a match', () => assert.equal(interceptor.getApiName(`${idBrokerURL}/horse/v1/myID`), 'horse'));
        it('returns identity API name if there is a match', () => assert.equal(interceptor.getApiName(`${identityURL}/horse/v1/myID`), 'horse'));
      });
