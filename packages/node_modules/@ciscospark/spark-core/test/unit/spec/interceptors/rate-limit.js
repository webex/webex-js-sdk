    ...
    describe(`RateLimitInterceptor`, () => {
      ...
      describe(`#getApiName`, () => {
        ...
        it(`returns identity API name if there is a match`, () => {
          assert.equal(interceptor.getApiName(`https://identity.webex.com/horse/v1/myID`), `horse`);
        });
      });
      ...
      describe(`#getRateLimitStatus`, () => {
        ...
        it(`returns false if identity API name is not rate limited`, () => {
          ...
          return sleep(2000)
           .then(() => {
             assert.equal(interceptor.getRateLimitStatus(`https://identity.webex.com/horse/v1/myID`), false);
           });
        });
        ...
        it(`returns true if the identity API name is rate limited`, () => {
          ...
          assert.equal(interceptor.getRateLimitStatus(`https://identity.webex.com/horse/v1/myID`), true);
        });
      });
      ...
      describe(`#extractRetryAfterTime`, () => {
        it(`returns 60 seconds when retry-after <= 0`, () => {
          assert.equal(interceptor.extractRetryAfterTime({
