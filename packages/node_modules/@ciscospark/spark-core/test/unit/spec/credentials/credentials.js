  ...
  describe('Credentials', () => {
    ...
    describe('#buildLoginUrl()', () => {
      ...
      it('generates the login url', () => {
        ...
        assert.equal(credentials.buildLoginUrl({state: {page: 'front'}}), 'https://idbroker.webex.com/idb/oauth2/v1/authorize?state=eyJwYWdlIjoiZnJvbnQifQ&client_id=fake&redirect_uri=http%3A%2F%2Fexample.com&scope=scope%3Aone&cisService=spark&response_type=code');
      });
    });
