...
import Logger from '@ciscospark/plugin-logger';
  ...
  describe('Credentials', () => {
    ...
    describe('#buildLogoutUrl()', () => {
      skipInBrowser(it)('generates the logout url', () => {
        ...
        spark.trigger('change:config');
        assert.equal(credentials.buildLogoutUrl(), `${process.env.IDBROKER_BASE_URL || 'https://idbroker.webex.com'}/idb/oauth2/v1/logout?cisService=spark&goto=ru`);
      });
      ...
      skipInBrowser(it)('includes a token param if passed', () => {
        ...
        spark.trigger('change:config');
        assert.equal(credentials.buildLogoutUrl({token: 't'}), `${process.env.IDBROKER_BASE_URL || 'https://idbroker.webex.com'}/idb/oauth2/v1/logout?cisService=spark&goto=ru&token=t`);
      });
