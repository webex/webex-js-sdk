...
const Call = SparkPlugin.extend({
   ...
   */
  updateMuteToggles() {
    const audioChanged = didChange('audio', this.media.offerSdp, this.media.answerSdp);
    const audioMuted = audioChanged ? this.sendingAudio : !this.sendingAudio;
    const videoChanged = didChange('video', this.media.offerSdp, this.media.answerSdp);
    const videoMuted = videoChanged ? this.sendingVideo : !this.sendingVideo;
