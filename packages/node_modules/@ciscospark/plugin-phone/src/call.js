...
const Call = SparkPlugin.extend({
  ...
  changeSendingAudio(value) {
    return new Promise((resolve) => {
      ...
      resolve(this.updateMuteToggles({audioMuted: !value}));
    });
  },
   ...
   * @returns {Promise}
   */
  updateMuteToggles({audioMuted, videoMuted} = {}) {
    this.logger.info(`updating mute toggles: audioMuted=${audioMuted} videoMuted=${videoMuted}`);
