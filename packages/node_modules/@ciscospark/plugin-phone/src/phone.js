...
const Phone = SparkPlugin.extend({
   ...
   */
  onLocusEvent(event) {
    // ROAP events carry a payload different from all other locus events (as of
    // 2018-01-17, only ROAP events stound out from the rest). We know that they
    // shouldnt cause us to ring, so they can be ignored by this handler.
