...
import {WebRTCMedia} from '@ciscospark/plugin-phone';
import {parse} from 'sdp-transform';
import {find} from 'lodash';
import {browserOnly, maxWaitForEvent, skipInFirefox} from '@ciscospark/test-helper-mocha';
...
browserOnly(describe)(`plugin-phone`, () => {
  describe(`WebRTCMedia`, () => {
    ...
    beforeEach(() => {
      ...
      if (navigator.mediaDevices.getUserMedia.restore) {
