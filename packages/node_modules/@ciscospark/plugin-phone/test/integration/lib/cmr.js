...
export default class CMR {
  static reserve(spark) {
    ...
    let resourceType = 'CMR_3';
    // Set resource type for known integration environment.
    if (process.env.WHISTLER_API_SERVICE_URL === 'https://whistler.onint.ciscospark.com/api/v1') {
      resourceType = 'CMR_4';
    }
    ...
    return spark.request({
      method: 'POST',
      uri: `${process.env.WHISTLER_API_SERVICE_URL || 'https://whistler-prod.onint.ciscospark.com/api/v1'}/reservations`,
      headers: {
