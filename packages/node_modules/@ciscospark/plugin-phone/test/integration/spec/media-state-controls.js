        ...
        describe(`when the call is started with audio`, () => {
          it(`stops receiving audio and starts receiving audio`, () => {
            ...
            return Promise.all([
              expectEvent(10000, `call:incoming`, mccoy.spark.phone)
                .then((c) => handleErrorEvent(c, () => c.answer())),
              handleErrorEvent(call, () => expectEvent(10000, `connected`, call)
                .then(() => assertLocusMediaState(call, {
                  sendingAudio: true,
                  sendingVideo: true,
                  receivingAudio: true,
          ...
          it(`stops sending audio then starts sending audio`, () => {
            ...
            return Promise.all([
              ...
              handleErrorEvent(call, () => expectEvent(10000, `connected`, call)
                ...
                .then(() => Promise.all([
                  expectEvent(10000, `remoteAudioMuted:change`, mccoyCall),
          ...
          it(`stops sending video then starts sending video`, () => {
            ...
            return Promise.all([
              ...
              handleErrorEvent(call, () => expectEvent(10000, `connected`, call)
                ...
                .then(() => Promise.all([
                  expectEvent(10000, `remoteVideoMuted:change`, mccoyCall),
