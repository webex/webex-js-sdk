  ...
  describe(`Phone`, () => {
    ...
    describe(`group calling events model`, () => {
      ...
      it(`async: proceeds through a seriees of events`, () => handleErrorEvent(spock.spark.phone.dial(room.id), async (call) => {
        ...
        // FIXME this part of the test is really unstable but I think it's
        // simply a result of the disaster that is the updateMedia endpoint.
        // I'm disabling it for now until we can (a) reduce negotiations when
        // muting and/or (b) move to roap to avoid using that endpoint. Moreover
        // mute is in media-state-controls.
        // await Promise.all([
        ...
        await Promise.all([
          ...
          // FIXME the disconnected event seems really flaky
