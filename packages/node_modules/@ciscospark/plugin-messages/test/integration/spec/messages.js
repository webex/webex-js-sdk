      ...
      describe('#listen()', () => {
        [
          ...
          it(`emits a "created" event when a "${verb}" activity arrives`, () => {
            ...
            const event = makeActivityEvent(props);
            const spy = sinon.spy();
      ...
      describe('#createMessagesEventData', () => {
        [
          ...
          it(`creates a messages event for a ${input.roomType} room`, () => {
            ...
            const activity = makeActivity(props);
        ...
        it('creates a messages event with files', () => {
          ...
          const activity = makeActivity(additionalProps);
          const event = spark.messages.createMessagesEventData(activity);
...
function makeActivityEvent(options) {
  return {
    data: {
      data: {
        activity: makeActivity(options),
...
function makeActivity(options) {
  ...
  return Object.assign(activity, options);
}
