...
describe('plugin-messages', function () {
  ...
  let server;
  nodeOnly(before)('start yakbak', () => {
    /* eslint-disable global-require */
    const http = require('http');
    const yakbak = require('yakbak');
    /* eslint-enable global-require */
    console.debug('starting yakbak server...');
    ...
    server = http.createServer(yakbak('https://api.ciscospark.com', {
  ...
  nodeOnly(after)('stop yakbak', () => {
    if (server) {
      console.log('closing yakbak server...');
      server.close(() => {
        console.log('yakbak server closed');
      });
    }
  });
});
