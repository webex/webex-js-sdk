...
const Messages = SparkPlugin.extend({
  ...
  initialize(...args) {
    ...
    this.listenTo(this.spark.internal.mercury, 'event:conversation.activity',
      (event) => this.onActivityEvent(event));
  },
  ...
  onActivityEvent(event) {
    // TODO: Will probably have to check for verb: "post"

    // NOTE: Public message format:
    // message
    // {
    ...
    //   "roomType": "group",
    //   "text": "g",
    //   "personId": "public person ID",
    //   "personEmail": "matnorri@cisco.com",
    //   "created": "2019-02-27T19:31:27.961Z"
    // },

    // TODO: Emit only the message
    const message = event;

    this.trigger(MESSAGES_CREATED, message);
  },
