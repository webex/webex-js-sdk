...
const Messages = SparkPlugin.extend({
   ...
   */
  async createMessagesEventData(activity) {
    const id = constructHydraId(hydraTypes.MESSAGE, activity.id);
    // Get decrypted text from Hydra instead of encrypted text
    // from the Mercury activity, i.e., activity.object.displayName.
