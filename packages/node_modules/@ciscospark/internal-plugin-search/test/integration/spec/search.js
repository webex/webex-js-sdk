...
describe('plugin-search', () => {
  describe('#people', () => {
    ...
    it('retrieves a bot', () => spark.internal.search.people({query: bot.botEmail, includeRobots: true})
      .then((bots) => {
        assert.isAbove(bots.length, 0, 'At least one bot was found');
        assert.equal(bots[0].email, bot.botEmail);
      }));

    it('doesn\'t retrieve a bot because of parameter', () => spark.internal.search.people({query: bot.botEmail, includeRobots: false})
      .then((bots) => {
