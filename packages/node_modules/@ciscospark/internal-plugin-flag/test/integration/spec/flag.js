...
describe('plugin-flag', function () {
  ...
  describe('Flag', () => {
    ...
    beforeEach('connect spock to mercury', () => spock.spark.internal.mercury.connect());
    beforeEach('connect mccoy to mercury', () => mccoy.spark.internal.mercury.connect());
    ...
    beforeEach('populate data', () => spock.spark.internal.conversation.create({
      ...
      .then((c) => {
        ...
        return mccoy.spark.internal.conversation.post(flagConversation, {
          displayName: 'Hi Dear, How are you?'
        });
      })
      .then(() => spock.spark.internal.conversation.post(flagConversation, {
        displayName: 'Hey! I am doing well. How are you?'
      }))
      .then(() => mccoy.spark.internal.conversation.post(flagConversation, {
      ...
      .then(() => {
        ...
        return spock.spark.internal.conversation.get(flagConversation, params);
      })
      .then((conversation) => {
    ...
    afterEach(() => spock.spark.internal.flag.list()
      .then((flags) => Promise.all(flags.map((flag) => spock.spark.internal.flag.delete(flag)
    ...
    describe('#flag()', () => {
      it('flags the activity', () => {
        ...
        return spock.spark.internal.flag.create(flaggedActivity1)
          .then((flagResponse1) => {
    ...
    describe('#list()', () => {
      it('fetches the flag list', () => spock.spark.internal.flag.list()
        .then((flagList) => {
      ...
      it('maps flags to activity', () => {
        ...
        return spock.spark.internal.flag.create(flaggedActivity1)
          .then((flagResponse1) => {
            ...
            return spock.spark.internal.flag.mapToActivities(flags)
              .then((activities) => {
      ...
      it('removes the flag from activity', () => {
        ...
        return spock.spark.internal.flag.create(flaggedActivity1)
          .then((flagResponse1) => {
            ...
            return spock.spark.internal.flag.delete(flagResponse1);
          })
          .then(() => spock.spark.internal.flag.list())
          .then((flagList) => {
            assert.isArray(flagList);
            assert.lengthOf(flagList, 0);
          });
      ...
      it('archives the flag for an activity', () => {
        ...
        return spock.spark.internal.flag.create(flaggedActivity1)
          .then((flagResponse1) => {
            ...
            return spock.spark.internal.flag.archive(flagResponse1);
          })
      ...
      it('unflag the flag for an activity', () => {
        ...
        return spock.spark.internal.flag.create(flaggedActivity1)
          .then((flagResponse1) => {
            ...
            return spock.spark.internal.flag.unflag(flagResponse1);
          })
