# @ciscospark/internal-ediscovery-report-client
...
```bash
npm install --save @ciscospark/internal-ediscovery-report-client
```
...
import '@ciscospark/internal-ediscovery-report-client';

import SparkCore from '@ciscospark/spark-core';

const spark = new SparkCore();
spark.internal.ediscoveryReportClient.WHATEVER
