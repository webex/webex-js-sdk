...
import Team from '@ciscospark/plugin-team';
...
describe(`plugin-team`, () => {
  describe(`Team`, () => {
    ...
    describe(`#prepareTeamConversation()`, () => {
      it(`requires a KRO`, () => assert.isRejected(spark.internal.team._prepareTeamConversation({}), /Error: Team general conversation must have a KRO/));
    });
