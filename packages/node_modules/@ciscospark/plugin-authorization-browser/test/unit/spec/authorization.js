      ...
      describe(`when there is a token in the url`, () => {
        ...
        it(`validates the csrf token`, () => {
          ...
          assert.throws(() => {
            ...
            const spark = makeSpark(`http://example.com/#access_token=AT&expires_in=3600&token_type=Bearer&refresh_token=RT&refresh_token_expires_in=36000&state=${base64.encode(JSON.stringify({csrf_token: csrfToken}))}`);
          }, /CSRF token abcd does not match stored token undefined/);
        ...
        it(`removes the oauth parameters from the url`, () => {
          ...
          return spark.authorization.when(`change:ready`)
            .then(() => {
              ...
              // TODO should authorization have a state property?
            });
        });
...
// TODO test logout behavior
// TODO test logout behavior with noRedirect set
// TODO test refreshCallback
