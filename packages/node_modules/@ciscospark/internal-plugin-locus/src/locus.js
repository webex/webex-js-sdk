...
const Locus = SparkPlugin.extend({
  ...
  /**
   * Sends a ROAP message via Locus
   * @param {Types~Locus} locus
   * @param {RoapMessage} msg
   * @returns {Promise<Locus>}
   */
  transmitRoapMessage(locus, msg) {
    return this.request({
      method: 'PUT',
