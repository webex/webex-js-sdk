...
import Device, {DeviceUrlInterceptor} from '@ciscospark/plugin-wdm';
...
describe(`plugin-wdm`, () => {
  describe(`DeviceUrlInterceptor`, () => {
    ...
    beforeEach(() => {
      ...
      spark.device.url = `https://wdm-a.example.com/devices/id`;
    ...
    describe(`#onRequest()`, () => {
      it(`adds cisco-device-url to the request header for service catalog services`, () => interceptor.onRequest({
        ...
        .then((options) => {
          ...
          assert.equal(options.headers[`cisco-device-url`], spark.device.url);
        }));
