...
const Encryption = SparkPlugin.extend({
  children: {
    /**
     * KMS Client bound to this plugin's spark instance
     * @memberof Encryption
     * @instance
     * @type {KMS}
     */
   ...
   * @memberof Encryption
   * @param {SCRObject} scr
   * @param {FileLike} buffer
   * @returns {Promise<BufferLike>}
   */
  ...
  /**
   * Decrypts a secure content reference
   * @instance
   * @memberof Encryption
   * @param {string|Key} key KMS Key Url or Key instance of the key used to encrypt cipherScr
   * @param {string} cipherScr
   * @returns {Promise<SCRObject>}
   */
   ...
   * @instance
   * @memberof Encryption
   * @param {string|Key} key KMS Key Url or Key instance of the key used to encrypt ciphertext
  ...
  /**
   * Downloads and decrypts the file identified by scr
   * @instance
   * @memberof Encryption
   * @param {SCRObject} scr
   * @returns {Promise<BufferLike>}
  ...
  /**
   * Fetches the download URL for the file identified by scr.loc
   * @instance
   * @memberof Encryption
   * @param {SCRObject} scr
   * @private
  ...
  /**
   * Encrypts a file, producing both an encrypted file and an unencrypted secure
   * content reference
   * @instance
   * @memberof Encryption
   * @param {FileLike} file
   * @returns {Promise<{scr: SCRObject, cdata: BufferLike}>}
   */
  encryptBinary(file) {
  ...
  /**
   * Retrieves a key. If URI is, in fact, a key, makes sure it's a key instance
   * and not plain object describing a key instance and returns it immediately.
   * If uri is a url, first checks the local cache, then requests the key from
   * the kms.
   * @instance
   * @memberof Encryption
   * @param {KeyLike} uri
