...
const Encryption = SparkPlugin.extend({
   ...
   * @instance
   * @memberof Encryption
   * @param {KeyLike} key KMS Key Url or Key instance of the key used to encrypt cipherScr
   ...
   * @instance
   * @memberof Encryption
   * @param {KeyLike} key KMS Key Url or Key instance of the key used to encrypt ciphertext
