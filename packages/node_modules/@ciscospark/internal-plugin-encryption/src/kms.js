  ...
  _getContext(onBehalfOf) {
    ...
    return Promise.all([
      ...
      .then(([context, authorization]) => {
        ...
        // Note: Setting the obBehalfOf userId here as _prepareContext() generates a 'create'
        // request where the userId must match the token.
        context.clientInfo.credential.userId = onBehalfOf || this.spark.internal.device.userId;
        return context;
      });
  },
