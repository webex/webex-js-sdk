    ...
    describe(`#listAuthorizations()`, () => {
        ...
        .then(([auth]) => {
          ...
          return spark.internal.encryption.kms.listAuthorizations({kroUri: kro.uri})
            .then((authorizations) => {
              ...
              assert.include(authorizations, {uri: auth.uri, authId: testUserId, resourceUri: auth.resourceUri});
              assert.include(authorizations, {uri: auth.uri, authId: testResourceId, resourceUri: auth.resourceUri});
            });
        }));
      ...
      it(`remove the user and verify this user is not in the authorization list `, () => spark.internal.encryption.kms.removeAuthorization({
        ...
        .then(([auth]) => {
          ...
          return spark.internal.encryption.kms.listAuthorizations({kroUri: kro.uri})
            .then((authorizations) => {
              assert.notInclude(authorizations, {uri: auth.uri, authId: testUserId, resourceUri: auth.resourceUri});
            });
        }));
      ...
      it(`remove the resource and verify this resource is not in the authorizaiton list`, () => spark.internal.encryption.kms.removeAuthorization({
        ...
        .then(([auth]) => {
          ...
          return spark.internal.encryption.kms.listAuthorizations({kroUri: kro.uri})
            .then((authorizations) => {
              assert.notInclude(authorizations, {uri: auth.uri, authId: testResourceId, resourceUri: auth.resourceUri});
            });
        }));
    });
