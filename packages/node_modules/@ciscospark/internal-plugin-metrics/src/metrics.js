...
const Metrics = SparkPlugin.extend({
  ...
  submitClientMetrics(eventName, props, preLoginId) {
    ...
    return this.sendBatchMetric(payload);
  },

  sendBatchMetric(payload) {
  ...
  registerMetric(eventName, id, props, type) {
  ...
  */
  clientRegisterMetric(eventName, id, props) {
    return this.registerMetric(eventName, id, props, this.CLIENT_METRIC);
  },
  ...
  */
  sdkRegisterMetric(eventName, id, props) {
    return this.registerMetric(eventName, id, props, this.SDK_METRIC);
  },
  ...
  updateRegisteredMetric(id, metricProps) {
    ...
    // update metric
    _.assign(props.fields, metricProps.fields);

    return this.storeMetric(id, props, type);
  },

  metricIsType(id, type) {
    return this.getMetric(id) && this.getMetric(id).type === type;
  },
  ...
  clientSendRegisteredMetric(id) {
    ...
    const httpResp = this.sendBatchMetric(this.getMetric(id).metric);
