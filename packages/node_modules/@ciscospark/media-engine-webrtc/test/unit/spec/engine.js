              ...
              describe(message, () => {
                ...
                step(`transitions to audio=${audioEnd} and video=${videoEnd}`, () => {
                  ...
                  return Promise.all([
                    ...
                    // Some combination of adapter.js and chrome causes the
                    // track event not to fire, but (it appears) streams
                    // otherwise get setup correctly
                    expectNewRemoteTrackOnTransition && (browser.chrome ? maxWaitForEvent(20000, `track`, engine) : expectEvent(20000, `track`, engine))
                  ])
                    .then(() => {
