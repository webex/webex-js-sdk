          ...
          videoStartStates.forEach((videoStart) => {
            ...
            videoEndStates.forEach((videoEnd) => {
              ...
              describe(message, () => {
                ...
                ((browser.chrome && flakyInChrome) ? it.skip : step)(`transitions to audio=${audioEnd} and video=${videoEnd}`, () => {
                ...
                ((browser.chrome && flakyInChrome) ? it.skip : step)(`returns to audio=${audioStart} and video=${videoStart}`, () => {
                  const sendingAudioSpy = sinon.spy();
                  const sendingVideoSpy = sinon.spy();
                  const receivingAudioSpy = sinon.spy();
                  const receivingVideoSpy = sinon.spy();
