  ...
  describe(`verbs`, () => {
    ...
    describe(`#updateTypingStatus()`, () => {
      ...
      it(`clears the typing indicator for the specified conversation`, () => {
        return spark.internal.conversation.updateTypingStatus(conversation, {typing: false})
      ...
      describe(`#removeAllMuteTags()`, () => {
        it(`removes all mute tags on the convo`, () => {
          return spark.internal.conversation.muteMessages(conversation)
            .then(() => {
              return spark.internal.conversation.muteMentions(conversation);
            })
            .then(() => {
              return spark.internal.conversation.removeAllMuteTags(conversation);
            })
            .then(() => spark.internal.conversation.get(conversation))
            .then((c) => {
        ...
        it(`removes all unmute tags on the convo`, () => {
          return spark.internal.conversation.unmuteMentions(conversation)
            .then(() => {
              return spark.internal.conversation.unmuteMessages(conversation);
            })
            .then(() => {
              return spark.internal.conversation.removeAllMuteTags(conversation);
            })
