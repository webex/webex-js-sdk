...
describe(`plugin-conversation`, function() {
  ...
  describe(`#get()`, () => {
    let conversation;
    before(`create conversation`, () => spark.conversation.create({participants: [mccoy.id]})
      .then((c) => {conversation = c;}));
  ...
  describe(`#listActivities()`, () => {
    let conversation;
    before(`create conversation with activity`, () => spark.conversation.create({participants})
      .then((c) => {
        conversation = c;
