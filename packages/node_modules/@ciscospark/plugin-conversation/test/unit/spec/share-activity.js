...
import {ShareActivity} from '@ciscospark/plugin-conversation';
import Mockpark from '@ciscospark/test-helper-mock-spark';
...
describe(`plugin-conversation`, () => {
  describe(`ShareActivity`, () => {
    describe(`#_determineContentCategory`, () => {
      let sa;
      beforeEach(() => {
        const spark = new Mockpark();
        sa = new ShareActivity({}, {parent: spark});
      });
