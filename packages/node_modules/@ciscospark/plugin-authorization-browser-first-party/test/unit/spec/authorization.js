  ...
  describe('Authorization', () => {
    function makeSpark(href = 'https://example.com', csrfToken = undefined, config = {}) {
      ...
      const spark = new MockSpark({
        ...
        config: merge({
          credentials: {
            authorizeUrl: `${process.env.IDBROKER_BASE_URL || 'https://idbrokerbts.webex.com'}/idb/oauth2/v1/authorize',
            logoutUrl: ``${process.env.IDBROKER_BASE_URL || 'https://idbrokerbts.webex.com'}/idb/oauth2/v1/logout`,
