  ...
  describe(`#setFeature()`, () => {
    ...
    [
      ...
      it(`sets a value for a ${keyType} feature toggle`, () => {
        return spark.internal.feature.setFeature(keyType, `testFeature`, false)
          .then((res) => {
            ...
            assert.becomes(spark.internal.feature.getFeature(keyType, `testFeature`), false);
          });
      });
    });
  });
  ...
  describe(`#setBatchUserFeatures()`, () => {
    ...
    it(`sets a value for two user feature toggle`, () => {
      ...
      return spark.internal.feature.setBundledFeatures(featureUpdateArray)
        .then(() => {
          return Promise.all([
            assert.becomes(spark.internal.feature.getFeature(`user`, `key1`), `value1`),
            assert.becomes(spark.internal.feature.getFeature(`user`, `key2`), `value2`)
          ]);
        });
    });
  });
