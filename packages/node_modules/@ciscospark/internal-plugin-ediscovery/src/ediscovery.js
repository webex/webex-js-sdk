    ...
    return this.getReport(reportId)
      .then((reportResponse) => {
        ...
        for (let offset = 0; offset < activityCount; offset += numberToRetrieve) {
          const promise = this.getPagedContent(reportId, offset, numberToRetrieve)
            .then((response) => {
              const activities = response.body;
              return this._decrypt(activities);
            })
            .then((activities) => {
        ...
        // Download the zip once all the activities have been added
