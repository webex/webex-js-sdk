...
describe('report-generator', () => {
  ...
  describe('Mapping', () => {
    it('map', async () => {
      const activitiesWithContent = activities.filter((activity) => activity.objectDisplayName);
      const activity = activitiesWithContent[0];
      const eml = generator.map(activity);
      // TODO: Disabling until addresses are re-supported
      // expect(eml).to.include(`From: ${activity.actorId}`);
