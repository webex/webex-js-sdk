...
import reportRequest from '@ciscospark/internal-plugin-ediscovery/src/report-request';
...
describe('Ediscovery Report API Tests', () => {
  ...
  describe('Create Report Tests', () => {
    it('createReportSuccess', async () => {
      const result = spark.internal.ediscovery.createReport(reportRequest.name, reportRequest.description, reportRequest.userIds, reportRequest.keywords, reportRequest.spaceNames, reportRequest.spaceIds, reportRequest.range).then((res) => {
