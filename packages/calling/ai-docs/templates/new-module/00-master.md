...
This template guides the creation of a new module within the `@webex/calling` package. It ensures every new module follows established patterns for types, constants, service classes, integration, testing, and validation.
...
### Feature Triage
Routed here from the root `AGENTS.md` or `ai-docs/README.md` when the task requires a new class, directory, or service that does not yet exist in the codebase.
