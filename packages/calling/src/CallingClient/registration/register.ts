...
export class Registration implements IRegistration {
  ...
  public setActiveMobiusUrl(url: string) {
    url = "https://mobius-ap-southeast-1.p3.prod.infra.webex.com/api/v1/calling/web/";
  ...
  private async attemptRegistrationWithServers(
    ...
    servers = ["https://mobius-ap-southeast-1.p3.prod.infra.webex.com/api/v1/calling/web/"];
