...
export const METHODS = {
  ...
  handleIncomingCallSetup: 'handleIncomingCallSetup',
  handleOutgoingCallSetup: 'handleOutgoingCallSetup',
  handleCallHold: 'handleCallHold',
  handleCallResume: 'handleCallResume',
  handleIncomingCallProgress: 'handleIncomingCallProgress',
  handleIncomingRoapOfferRequest: 'handleIncomingRoapOfferRequest',
  handleOutgoingCallAlerting: 'handleOutgoingCallAlerting',
  handleIncomingCallConnect: 'handleIncomingCallConnect',
  handleOutgoingCallConnect: 'handleOutgoingCallConnect',
  handleIncomingCallDisconnect: 'handleIncomingCallDisconnect',
  handleOutgoingCallDisconnect: 'handleOutgoingCallDisconnect',
  handleCallEstablished: 'handleCallEstablished',
  handleUnknownState: 'handleUnknownState',
  handleTimeout: 'handleTimeout',
  getEmitterCallback: 'getEmitterCallback',
  handleRoapEstablished: 'handleRoapEstablished',
  handleRoapError: 'handleRoapError',
  handleOutgoingRoapOffer: 'handleOutgoingRoapOffer',
  handleOutgoingRoapAnswer: 'handleOutgoingRoapAnswer',
  handleIncomingRoapOffer: 'handleIncomingRoapOffer',
  handleIncomingRoapAnswer: 'handleIncomingRoapAnswer',
  forceSendStatsReport: 'forceSendStatsReport',
  updateActiveMobius: 'updateActiveMobius',
  dequeueWsEvents: 'dequeueWsEvents',
  getCall: 'getCall',
  getActiveCalls: 'getActiveCalls',
  updateLine: 'updateLine',
  getLineId: 'getLineId',
  initMediaConnection: 'initMediaConnection',
  getDirection: 'getDirection',
  getCallId: 'getCallId',
  getCorrelationId: 'getCorrelationId',
  sendCallStateMachineEvt: 'sendCallStateMachineEvt',
  sendMediaStateMachineEvt: 'sendMediaStateMachineEvt',
  setCallId: 'setCallId',
  ...
  post: 'post',
  patch: 'patch',
  postSSRequest: 'postSSRequest',
  postStatus: 'postStatus',
  completeTransfer: 'completeTransfer',
  getCallStats: 'getCallStats',
  postMedia: 'postMedia',
  mediaRoapEventsListener: 'mediaRoapEventsListener',
  mediaTrackListener: 'mediaTrackListener',
  onEffectEnabled: 'onEffectEnabled',
  onEffectDisabled: 'onEffectDisabled',
  updateTrack: 'updateTrack',
  registerEffectListener: 'registerEffectListener',
  unregisterListeners: 'unregisterListeners',
  registerListeners: 'registerListeners',
  delete: 'delete',
  submitCallErrorMetric: 'submitCallErrorMetric',
  handleMidCallEvent: 'handleMidCallEvent',
  getCallerInfo: 'getCallerInfo',
  end: 'end',
  doHoldResume: 'doHoldResume',
  startCallerIdResolution: 'startCallerIdResolution',
  sendDigit: 'sendDigit',
  mute: 'mute',
  isMuted: 'isMuted',
  ...
  setBroadworksCorrelationInfo: 'setBroadworksCorrelationInfo',
  getBroadworksCorrelationInfo: 'getBroadworksCorrelationInfo',
  getCallRtpStats: 'getCallRtpStats',
  register: 'register',
  deregister: 'deregister',
  normalizeLine: 'normalizeLine',
  lineEmitter: 'lineEmitter',
  getLoggingLevel: 'getLoggingLevel',
  getActiveMobiusUrl: 'getActiveMobiusUrl',
  getStatus: 'getStatus',
  getDeviceId: 'getDeviceId',
  makeCall: 'makeCall',
  incomingCallListener: 'incomingCallListener',
  setMobiusServers: 'setMobiusServers',
  handleConnectionRestoration: 'handleConnectionRestoration',
  reconnectOnFailure: 'reconnectOnFailure',
  detectNetworkChange: 'detectNetworkChange',
  getClientRegionInfo: 'getClientRegionInfo',
  getMobiusServers: 'getMobiusServers',
  registerCallsClearedListener: 'registerCallsClearedListener',
  callsClearedHandler: 'callsClearedHandler',
  registerSessionsListener: 'registerSessionsListener',
  createLine: 'createLine',
  getLines: 'getLines',
  uploadLogs: 'uploadLogs',
  getSDKConnector: 'getSDKConnector',
  getConnectedCall: 'getConnectedCall',
};
