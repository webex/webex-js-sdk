...
class MetricManager implements IMetricManager {
  ...
  public submitSTMetric(
    ...
    if (name === METRIC_EVENT.ST_ENABLED) {
      data = {
        tags: {
          device_id: this.deviceInfo?.device?.deviceId,
          service_indicator: this.serviceIndicator,
  ...
  public submitModelChangedMetric(
    name: METRIC_EVENT,
    type: METRIC_TYPE,
    callId: CallId,
    correlationId: CorrelationId,
    ...
    if (name === METRIC_EVENT.MODEL_CHANGED) {
      data = {
        tags: {
          device_id: this.deviceInfo?.device?.deviceId,
          service_indicator: this.serviceIndicator,
      ...
      log.warn('Invalid metric name received. Rejecting request to submit metric.', {
        file: METRIC_FILE,
        method: 'submitModelChangedMetric',
      });
    }
